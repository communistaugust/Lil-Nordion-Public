    ...
    .section Chapter06EventsSection
      ...
      aChapter06MapEvents ; B2/804F
        ...
        CHECK_TALK FlagChapter06_SofalaTalkCheck, AnyCharacter, SofalaArmy2
          EVENT FlagAlways, EventChapter06SofalaArmyTalk

        CHECK_TALK FlagChapter06_IsaachTalkCheck, AnyCharacter, IsaachArmy2
        ...
        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, Iuchar, AnyFactionSlot, Danann
          SET_PRECOMBAT_DIALOGUE FlagChapter06_IucharDanannBattleQuote, dialogueCh6BattleDanann_Iuchar, $46

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, Iucharba, AnyFactionSlot, Danann
          SET_PRECOMBAT_DIALOGUE FlagChapter06_IucharbaDanannBattleQuote, dialogueCh6BattleDanann_Iucharba, $46

        CHECK_UNITS_FIGHTING FlagAlways, AnyFactionSlot, Iucharba, AnyFactionSlot, Iuchar
          SET_PRECOMBAT_DIALOGUE FlagChapter06_IucharbaIucharBattleQuote, dialogueCh6BattleIuchar_Iucharba_viceversa, $43

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, Larcei, AnyFactionSlot, Iucharba
          SET_BATTLE_OR_DEATH_QUOTE FlagChapter06_LarceiCreidne_IucharbaBattleQuote, dialogueCh6BattleIucharba_LarceiCreidne, 0
        ...
        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, Larcei, AnyFactionSlot, Iuchar
          SET_BATTLE_OR_DEATH_QUOTE FlagChapter06_LarceiCreidne_IucharBattleQuote, dialogueCh6BattleIuchar_LarceiCreidne, 0
        ...
        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, Seliph, AnyFactionSlot, Danann
          SET_PRECOMBAT_DIALOGUE FlagChapter06_SeliphDanannBattleQuote, dialogueCh6BattleDanann_Seliph, $43

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, AnyCharacter, AnyFactionSlot, Harold
          SET_BATTLE_OR_DEATH_QUOTE FlagChapter06_HaroldBattleQuote, dialogueCh6BattleHarold, 0

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, AnyCharacter, AnyFactionSlot, Iucharba
          SET_BATTLE_OR_DEATH_QUOTE FlagChapter06_IucharbaBattleQuote, dialogueCh6BattleIucharba, 0

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, AnyCharacter, AnyFactionSlot, Iuchar
          SET_BATTLE_OR_DEATH_QUOTE FlagChapter06_IucharBattleQuote, dialogueCh6BattleIuchar, 0

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, AnyCharacter, AnyFactionSlot, Schmidt
          SET_BATTLE_OR_DEATH_QUOTE FlagChapter06_SchmidtBattleQuote, dialogueCh6BattleSchmidt, 0

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, AnyCharacter, AnyFactionSlot, Danann
          SET_BATTLE_OR_DEATH_QUOTE FlagChapter06_DanannBattleQuote, dialogueCh6BattleDanann, 0
    ...
    .section Chapter06EventDataSection
      ...
      aFactionGroupData24 ; B2/8378
        ...
        .structFactionGroupData FactionGanesha, BattleHUDColorGray, BattleBannerDozel, None, aFactionGroupData24._Locations, aFactionGroupData24._GroupAI
      ...
      aChapter06TalkEvents ; B2/83FF
        ...
        .structChapterTalkEventEntry Chapter06, FlagChapter06_IsaachTalkCheck, Tristan, IsaachArmy2
        .structChapterTalkEventEntry Chapter06, FlagChapter06_IsaachTalkCheck, Deimne, IsaachArmy2
        .structChapterTalkEventEntry Chapter06, FlagChapter06_IsaachTalkCheck, Diarmuid, IsaachArmy2
        .structChapterTalkEventEntry Chapter06, FlagChapter06_IsaachTalkCheck, Lester, IsaachArmy2
        .structChapterTalkEventEntry Chapter06, FlagChapter06_SofalaTalkCheck, Tristan, SofalaArmy2
        .structChapterTalkEventEntry Chapter06, FlagChapter06_SofalaTalkCheck, Deimne, SofalaArmy2
        .structChapterTalkEventEntry Chapter06, FlagChapter06_SofalaTalkCheck, Diarmuid, SofalaArmy2
        .structChapterTalkEventEntry Chapter06, FlagChapter06_SofalaTalkCheck, Lester, SofalaArmy2
        .word $FFFF
