    ...
    aEventChapter01Opening ; 90/82AE
      ...
      CASTLE_NAME $504a20, CASLTE_NAME_YELLOW, 150
      YIELD
      ...
      CASTLE_NAME $504a30, CASLTE_NAME_BLUE, 120

      CONTINUE_FORM_MAP_SPRITE_HALT
      DIALOGUE_WITH_BG dialogueCh1Intro2, DIALOGUE_BG_THRONE, 3, 2
      YIELD
      ...
      CASTLE_NAME $504a40, CASLTE_NAME_RED, 90
      YIELD

      DIALOGUE_WITH_BG dialogueCh1Intro3, DIALOGUE_BG_HALLWAY, 3, 1
