  ...
  aEventChapter01EdainGroupSpawn ; 90/8484
    ...
    CASTLE_NAME $504a50, CASLTE_NAME_RED, 90
    YIELD
    ...
    DIALOGUE dialogueCh1Turn2SigurdPhase1
    YIELD
    ...
    DIALOGUE dialogueCh1Turn2SigurdPhase2
    YIELD
    ...
    DIALOGUE_WITH_BG dialogueCh1Turn2SigurdPhase3, DIALOGUE_BG_HALLWAY, 3, 2
    YIELD
