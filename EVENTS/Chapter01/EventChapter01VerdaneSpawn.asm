  ...
  aEventChapter01VerdaneSpawn ; 90/88F8
    ...
    CASTLE_NAME $504a60, CASLTE_NAME_RED, 90
    YIELD
    ...
    DIALOGUE_WITH_BG dialogueCh1SeizeMarpha3, DIALOGUE_BG_HALLWAY, 3, 2
    ...
    DIALOGUE_WITH_BG dialogueCh1SeizeMarpha4, DIALOGUE_BG_HALLWAY, 3, 2
    YIELD
