  ...
  aEventChapter01WorldMap ; 8D/FCDF
    ...
    WM_DIALOGUE dialogueCh1WM2
    YIELD

    WM_HIGHLIGHT 0
    WM_DIALOGUE dialogueCh1WM3
    PAUSE 100
    YIELD
    ...
    WM_DIALOGUE dialogueCh1WM4
    YIELD

    WM_DIALOGUE dialogueCh1WM5
    YIELD
