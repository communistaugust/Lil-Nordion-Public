    ...
    .weak
      ...
      FlagChapter05EndAlive_Beowolf               := 29
    ...
    .section Chapter05EventsSection
      ...
      aChapter05MapEvents ; 86/DEBA
        ...
        CHECK_UNIT_IN_AREA FlagChapter05_ArdenOnCliffCheck, Arden, pack([36, 22]), pack([37, 22]),FS_Player
          EC_NOP_00

        CHECK_UNIT_DIED FlagChapter05_SladeDied, Slade, AnyFactionSlot
          EC_NOP_00
        ...
        CHECK_TALK FlagAlways, Lachesis, Beowolf
        ...
        CHECK_UNITS_FIGHTING FlagAlways, AnyFactionSlot, Slade, AnyFactionSlot, Byron
          SET_BATTLE_OR_DEATH_QUOTE FlagChapter05_ByronSlayderBattleQuote, dialogueCh5BattleSlade_Byron, 0

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, Lex, AnyFactionSlot, LombardCh05
          SET_PRECOMBAT_DIALOGUE FlagChapter05_LexLombardBattleQuote, dialogueCh5BattleLombard_Lex2, $46

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, Tailtiu, AnyFactionSlot, ReptorCh05
          SET_PRECOMBAT_DIALOGUE FlagChapter05_TailtiuReptorBattleQuote, dialogueCh5BattleReptor_Tailtiu, $46

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, Sigurd, AnyFactionSlot, Magon
          SET_BATTLE_OR_DEATH_QUOTE FlagChapter05_SigurdMagornBattleQuote, dialogueCh5BattleMagon_Sigurd, 0

        CHECK_UNITS_FIGHTING FlagAlways, AnyFactionSlot, LombardCh05, AnyFactionSlot, Sigurd
          SET_PRECOMBAT_DIALOGUE FlagChapter05_SigurdLombardBattleQuote, dialogueCh5BattleLombard_Sigurd, $46

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, Sigurd, AnyFactionSlot, ReptorCh05
          SET_PRECOMBAT_DIALOGUE FlagChapter05_SigurdReptorBattleQuote, dialogueCh5BattleReptor_Sigurd, $46

        CHECK_UNITS_FIGHTING FlagAlways, FS_Ch05Velthomer, Aida, AnyFactionSlot, ReptorCh05
          SET_PRECOMBAT_DIALOGUE FlagChapter05_AidaReptorBattleQuote, dialogueCh5BattleReptor_Aida, $74

        CHECK_UNITS_FIGHTING FlagAlways, AnyFactionSlot, AndreyCh05, AnyFactionSlot, Edain
          SET_PRECOMBAT_DIALOGUE FlagChapter05_EdainAndreyBattleQuote, dialogueCh5BattleAndrey_Edain, $43

        CHECK_UNITS_FIGHTING FlagAlways, AnyFactionSlot, AndreyCh05, AnyFactionSlot, Brigid
          SET_PRECOMBAT_DIALOGUE FlagChapter05_BrigidAndreyBattleQuote, dialogueCh5BattleAndrey_Brigid, $43

        CHECK_UNITS_FIGHTING FlagAlways, FS_Ch05Leonster, Ethlyn, FS_Ch05Thracia, AnyCharacter
          SET_PRECOMBAT_DIALOGUE FlagChapter05_EthlynThraciaBattleQuote, dialogueCh5BattleEthlyn, $46

        CHECK_UNITS_FIGHTING FlagChapter05_QuanThraciaBattleQuoteCheck, FS_Ch05Leonster, Quan, FS_Ch05Thracia, AnyCharacter
          EC_NOP_00

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, AnyCharacter, AnyFactionSlot, Slade
          SET_BATTLE_OR_DEATH_QUOTE FlagChapter05_SlayderBattleQuote, dialogueCh5BattleSlade, 0

        CHECK_UNITS_FIGHTING FlagAlways, FS_Ch05Lubeck, AnyCharacter, AnyFactionSlot, Byron
          SET_BATTLE_OR_DEATH_QUOTE FlagChapter05_ByronLubeckBattleQuote, dialogueCh5BattleByron, 0

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, AnyCharacter, AnyFactionSlot, AndreyCh05
          SET_BATTLE_OR_DEATH_QUOTE FlagChapter05_AndreyBattleQuote, dialogueCh5BattleAndrey, 0

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, AnyCharacter, AnyFactionSlot, LombardCh05
          SET_BATTLE_OR_DEATH_QUOTE FlagChapter05_LombardBattleQuote, dialogueCh5BattleLombard, 0

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, AnyCharacter, AnyFactionSlot, Vaja
          SET_BATTLE_OR_DEATH_QUOTE FlagChapter05_VajaBattleQuote, dialogueCh5BattleVaja, 0

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, AnyCharacter, AnyFactionSlot, Travant
          SET_BATTLE_OR_DEATH_QUOTE FlagChapter05_TravantBattleQuote, dialogueCh5BattleTravant, 0

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, AnyCharacter, AnyFactionSlot, Magon
          SET_BATTLE_OR_DEATH_QUOTE FlagChapter05_MagornBattleQuote, dialogueCh5BattleMagon, 0
        ...
        CHECK_FLAG_UNSET FlagChapter05_QuanBattleQuote
          CHECK_FLAG_SET FlagChapter05_QuanThraciaBattleQuoteCheck
            CHECK_FLAG_UNSET FlagChapter05_EthlynDiedCheck
              SET_PRECOMBAT_DIALOGUE FlagChapter05_QuanBattleQuote, dialogueCh5BattleQuan_EthlynAlive, $46
        BREAK_STATE_CHECKS

        CHECK_FLAG_UNSET FlagChapter05_QuanBattleQuote
          CHECK_FLAG_SET FlagChapter05_QuanThraciaBattleQuoteCheck
            CHECK_FLAG_SET FlagChapter05_EthlynDiedCheck
              SET_PRECOMBAT_DIALOGUE FlagChapter05_QuanBattleQuote, dialogueCh5BattleQuan_EthlynDead, $46
        BREAK_STATE_CHECKS
        ...
        CHECK_FLAG_UNSET FlagChapter05_ReptorBattleQuote
          CHECK_FLAG_SET FlagChapter05_ReptorBattleQuoteCheck
            CHECK_FLAG_UNSET FlagChapter05_AidaBetrayal
              SET_BATTLE_OR_DEATH_QUOTE FlagChapter05_ReptorBattleQuote, dialogueCh5BattleReptor_BeforeVelthomerTurns, 0
        BREAK_STATE_CHECKS

        CHECK_FLAG_UNSET FlagChapter05_ReptorBattleQuote
          CHECK_FLAG_SET FlagChapter05_ReptorBattleQuoteCheck
            CHECK_FLAG_SET FlagChapter05_AidaBetrayal
              SET_BATTLE_OR_DEATH_QUOTE FlagChapter05_ReptorBattleQuote, dialogueCh5BattleReptor_AfterVelthomerTurns, 0
        BREAK_STATE_CHECKS
        ...
        CHECK_FLAG_SET FlagChapter05_ReptorDeathQuoteCheck
          CHECK_FLAG_UNSET FlagChapter05_ReptorDeathQuote
            CHECK_FLAG_UNSET FlagChapter05_AidaBetrayal
              SET_BATTLE_OR_DEATH_QUOTE FlagChapter05_ReptorDeathQuote, dialogueCh5BattleLombard_Lex1, 1
        BREAK_STATE_CHECKS
        ...
        CHECK_TURN_PHASE_AI_ACTOR AnyTurn, FS_Ch05Lubeck, 7, AnyCharacter
          CHECK_FLAG_SET FlagChapter05_SladeDied
        ...
        _AliveUnitsFlags..= [(Beowolf,   FlagChapter05EndAlive_Beowolf )]
        ...
        CHECK_TURN_PHASE_AI_ACTOR AnyTurn, FS_Player
          ...
          CHECK_FLAG_SET FlagChapter05_PhinoraSeizedCheck
            CHECK_FLAG_UNSET FlagChapter05_ReptorDied
              ...
              SET_TALK_TARGET_IF_MARRIED FlagChapter05_LachesisLoverTalkSet,  Lachesis, Beowolf
    ...
    .section Chapter05EventDataSection
      ...
      aChapter05PhinoraCastle ; 86/E543
        ...
        .structChapterCastleLocationEntry Ch05_Phinora, FionnualaName, [42, 24], $FC, None
      ...
      aFactionGroupData1C ; 86/E626
        ...
        .structFactionGroupData FactionFionnuala, BattleHUDColorDarkBlue, BattleBannerVelthomer, None, aFactionGroupData1C._Locations, aFactionGroupData1C._GroupAI
      ...
      aFactionGroupData20 ; 86/E670
        ...
        .structFactionGroupData FactionFriege1, BattleHUDColorDarkBlue, BattleBannerFriege, None, None, aFactionGroupData20._GroupAI
      ...
      aFactionGroup1BAI7 ; 86/E6C3
        ...
        AI_SET_FORMATION $08, $03
        AI_JUMP_IF_CHAPTER_EVENT_FLAG_SET Chapter05, FlagChapter05_SladeDied, +
