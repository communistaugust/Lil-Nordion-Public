  ...
  aEventChapter10MiletosSeized ; 8D/8A04
    ...
    JUMP_TRUE _JuliusIshtarLeftAlready
      ...
      FILL_EVENT_UNIT_SLOT Julius, EventUnitSlot1
      ...
      DIALOGUE dialogueCh10SeizeMiletos1_JuliusIshtarAround
      YIELD
      ...
      FILL_EVENT_UNIT_SLOT Ishtar2, EventUnitSlot1
      MAP_SCROLL_TO_EVENT_UNIT_SLOT_1 4
      YIELD
    ...
    DIALOGUE_WITH_BG dialogueCh10SeizeMiletos2, DIALOGUE_BG_HALLWAY, 3, 2
    YIELD
