  ...
  aEventChapter10Opening ; 8D/863F
    ...
    CASTLE_NAME $504c50, CASLTE_NAME_RED, 150
    YIELD

    DIALOGUE_WITH_BG dialogueCh10Intro1, DIALOGUE_BG_HALLWAY, 3, 2
    ...
    CASTLE_NAME $504c60, CASLTE_NAME_RED, 100
    YIELD
    ...
    DIALOGUE_WITH_BG dialogueCh10Intro3, DIALOGUE_BG_HALLWAY, 3, 2
    YIELD
    ...
    CASTLE_NAME $504c40, CASLTE_NAME_BLUE, 100
    YIELD

    DIALOGUE_WITH_BG dialogueCh10Intro4, DIALOGUE_BG_ALLEY, 5, 3
    YIELD
    ...
    DIALOGUE_WITH_BG dialogueCh10Intro5, DIALOGUE_BG_THRONE, 3, 3
    YIELD
