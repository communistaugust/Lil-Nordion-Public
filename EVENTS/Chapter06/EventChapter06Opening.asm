  ...
  aEventChapter06Opening ; 91/CE2B
    ...
    FADE_IN_BY_TIMER 3
    CASTLE_NAME $504be0, CASLTE_NAME_RED, 120
    YIELD
    ...
    DIALOGUE_WITH_BG dialogueCh6Intro1, DIALOGUE_BG_HALLWAY, 3, 2
    YIELD
    ...
    CASTLE_NAME $504bd0, CASLTE_NAME_BLUE, 170
    ...
    DIALOGUE_WITH_BG dialogueCh6Intro2, DIALOGUE_BG_THRONE, 3, 2
    YIELD
