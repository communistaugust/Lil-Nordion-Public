  ...
  aEventChapter06SchmidtSpawn ; 91/D29E
    ...
    CASTLE_NAME $504bf0, CASLTE_NAME_RED, 90
    YIELD
    ...
    DIALOGUE_WITH_BG dialoguech6SeizeGanesha3, DIALOGUE_BG_HALLWAY, 3, 1
    YIELD
    ...
    DIALOGUE dialoguech6SeizeGanesha4
    YIELD

    MAP_SCROLL [45, 27], 4
    YIELD

    DIALOGUE dialoguech6SeizeGanesha5
    YIELD
