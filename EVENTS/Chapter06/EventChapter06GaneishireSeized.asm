  ...
  aEventChapter06GaneishireSeized ; 91/D176
    ...
    DIALOGUE_WITH_BG dialoguech6SeizeGanesha1, DIALOGUE_BG_ALLEY, 3, 2
    ...
    MOVE_TEMPORARY_TO_COORDS ArvisPrologue, [56, 16], [51, 23], 4, 0, MAP_SPRITE_GREEN, true
    ...
    DIALOGUE_WITH_BG dialoguech6SeizeGanesha2, DIALOGUE_BG_ALLEY, 3, 1
    YIELD
