    ...
    .weak
      ...
      FlagChapter10_SeliphPolemarchTalk            := 16
      ...
      FlagChapter10_SeliphPolemarchTalkCheck       := 43
    ...
    .section Chapter10EventsSection
      ...
      aChapter10MapEvents ; B0/805F
        ...
        CHECK_TALK FlagChapter10_SeliphPolemarchTalkCheck, Seliph, Polemarch
          EVENT FlagChapter10_SeliphPolemarchTalk, EventChapter10SeliphPalmarchTalk

        CHECK_UNIT_DIED_TO FlagChapter10_SeliphKilledArvis, Arvis3, Seliph
          EC_NOP_00
        ...
        CHECK_UNIT_DIED_TO FlagChapter10_JuliusKilledUnitCheck, AnyCharacter, Julius
          SET_FLAG FlagChapter10_KillingMinigameCompleted

        CHECK_UNIT_DIED_TO FlagChapter10_IshtarKilledUnitCheck, AnyCharacter, Ishtar2
          SET_FLAG FlagChapter10_KillingMinigameCompleted

        CHECK_UNIT_DIED_TO FlagAlways, Hilda1, AnyCharacter
          COMBATANTS_STAY_ON_MAP

        CHECK_UNIT_DIED FlagAlways, Hilda1, AnyCharacter
          EVENT FlagAlways, EventChapter10HildaDied

        CHECK_UNIT_DIED_TO FlagAlways, Ishtar2, AnyCharacter
          COMBATANTS_STAY_ON_MAP

        CHECK_UNIT_DIED FlagChapter10_KillingMinigameCompleted, Ishtar2, AnyCharacter
          EVENT FlagAlways, EventChapter10IshtarDied

        CHECK_UNIT_DIED_TO FlagAlways, Julius, AnyCharacter
          COMBATANTS_STAY_ON_MAP

        CHECK_UNIT_DIED FlagChapter10_KillingMinigameCompleted, Julius, AnyCharacter
        ...
        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, Seliph, AnyFactionSlot, Arvis3
          SET_PRECOMBAT_DIALOGUE FlagChapter10_SeliphArvisBattleQuote, dialogueCh10BattleArvis_Seliph, $74

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, Tine, AnyFactionSlot, Hilda1
          SET_PRECOMBAT_DIALOGUE FlagChapter10_TineLinda_HildaBattleQuote, dialogueCh10BattleHilda_TineLinda, $46

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, Linda, AnyFactionSlot, Hilda1
          SET_PRECOMBAT_DIALOGUE FlagChapter10_TineLinda_HildaBattleQuote, dialogueCh10BattleHilda_TineLinda, $46

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, Seliph, AnyFactionSlot, Hilda1
          SET_BATTLE_OR_DEATH_QUOTE FlagChapter10_SeliphHildaBattleQuote, dialogueCh10BattleHilda_Seliph, 0

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, AnyCharacter, AnyFactionSlot, Riedel
          SET_BATTLE_OR_DEATH_QUOTE FlagChapter10_RiddellBattleQuote, dialogueCh10BattleRiedel, 0

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, AnyCharacter, AnyFactionSlot, Hilda1
          SET_BATTLE_OR_DEATH_QUOTE FlagChapter10_HildaBattleQuote, dialogueCh10BattleHilda, 0

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, AnyCharacter, AnyFactionSlot, Morrigan
          SET_BATTLE_OR_DEATH_QUOTE FlagChapter10_MorriganBattleQuote, dialogueCh10BattleMorrigan, 0

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, AnyCharacter, AnyFactionSlot, Julius
          SET_BATTLE_OR_DEATH_QUOTE FlagChapter10_JuliusBattleQuote, dialogueCh10BattleJulius, 0

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, AnyCharacter, AnyFactionSlot, Ishtar2
          SET_BATTLE_OR_DEATH_QUOTE FlagChapter10_IshtarBattleQuote, dialogueCh10BattleIshtar, 0

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, AnyCharacter, AnyFactionSlot, Zagam
          SET_BATTLE_OR_DEATH_QUOTE FlagChapter10_ZagamBattleQuote, dialogueCh10BattleZagam, 0

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, AnyCharacter, AnyFactionSlot, Arvis3
          SET_BATTLE_OR_DEATH_QUOTE FlagChapter10_ArvisBattleQuote, dialogueCh10BattleArvis, 0
    ...
    .section Chapter10EventDataSection
      ...
      aChapter10PerulukeCastle ; B0/8350
        ...
        .structChapterCastleLocationEntry Ch10_Peruluke, PlutarchName, [57, 34], $FC, aChapter10ShopData

      aChapter10ChronosCastle ; B0/8358

        .structChapterCastleLocationEntry Ch10_Chronos, KronosName, [36, 48], $FC, None

      aChapter10RadosCastle ; B0/8360

        .structChapterCastleLocationEntry Ch10_Rados, RhodosName, [5, 56], $FC, None
      ...
      aChapter10TalkEvents ; B0/83E3
        ...
        .structChapterTalkEventEntry Chapter10, FlagChapter10_SeliphPolemarchTalkCheck, Seliph, Polemarch
        .word $FFFF
      ...
      aFactionGroupData38 ; B0/83FA
        ...
        .structFactionGroupData FactionKronos, BattleHUDColorOrange, BattleBannerFriege, None, aFactionGroupData38._Locations, aFactionGroupData38._GroupAI
      ...
      aFactionGroupData39 ; B0/8412
        ...
        .structFactionGroupData FactionRhodos, BattleHUDColorOrange, BattleBannerFriege, None, aFactionGroupData39._Locations, aFactionGroupData39._GroupAI
      ...
      aFactionGroup3BAI4 ; B0/84BC
        ...
        AI_TARGET_SPECIFIED_UNIT Polemarch
        AI_TARGET_ALL_FOES
        AI_END
