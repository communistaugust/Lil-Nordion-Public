    ...
    .weak
      ...
      FlagChapter09_CoirpreCharlot_HannibalTalk       := 14
      ...
      FlagChapter09_MousaBattleQuote                  := 29
      ...
      FlagChapter09_CoirpreCharlot_HannibalTalkCheck  := 41
      ...
      FlagChapter09_MousaDiedCheck                    := 48
    ...
    .section Chapter09EventsSection
      ...
      aChapter09MapEvents ; 86/F52B
        ...
        CHECK_CHILD_TALK FlagChapter09_CoirpreCharlot_HannibalTalkCheck, Charlot, Hannibal
          EVENT FlagChapter09_CoirpreCharlot_HannibalTalk, EventChapter09CoirpreCharlot_HannibalTalk
        ...
        CHECK_UNIT_DIED FlagChapter09_TravantDiedCheck, Travant2
          EC_NOP_00

        CHECK_UNIT_DIED FlagChapter09_MousaDiedCheck, Mousa
          EC_NOP_00

        CHECK_UNIT_DIED_TO FlagChapter09_ArionDiedCheck, Arion1, AnyCharacter
          COMBATANTS_STAY_ON_MAP

        CHECK_UNIT_DIED FlagAlways, Arion1, AnyCharacter
        ...
        CHECK_CHILD_TALK FlagAlways, Patty, Coirpre
          EVENT FlagAlways, EventChapter09PattyDaisy_CoirpreCharlotTalk
        ...
        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, Altena, AnyFactionSlot, Arion1
          SET_PRECOMBAT_DIALOGUE FlagChapter09_AltenaArionBattleQuote, dialogueCh9BattleArion_Altena, $46

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, Leif, AnyFactionSlot, Altena
          SET_PRECOMBAT_DIALOGUE FlagChapter09_LeifAltenaBattleQuote, dialogueCh9BattleAltena_Leif, $46

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, AdultFinn, AnyFactionSlot, Altena
          SET_PRECOMBAT_DIALOGUE FlagChapter09_FinnAltenaBattleQuote, dialogueCh9BattleAltena_Finn, $46

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, Leif, AnyFactionSlot, Travant2
          SET_PRECOMBAT_DIALOGUE FlagChapter09_LeifTravantBattleQuote, dialogueCh9BattleTravant_Leif, $46

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, AdultFinn, AnyFactionSlot, Travant2
          SET_PRECOMBAT_DIALOGUE FlagChapter09_FinnTravantBattleQuote, dialogueCh9BattleTravant_Finn, $46

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, Seliph, AnyFactionSlot, Arion1
          SET_PRECOMBAT_DIALOGUE FlagChapter09_SeliphArionBattleQuote, dialogueCh9BattleArion_Seliph, $46

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, AnyCharacter, AnyFactionSlot, Altena
          SET_BATTLE_OR_DEATH_QUOTE FlagChapter09_AltenaBattleQuote, dialogueCh9BattleAltena, 0

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, AnyCharacter, AnyFactionSlot, Hannibal
          SET_BATTLE_OR_DEATH_QUOTE FlagChapter09_HannibalBattleQuote, dialogueCh9BattleHannibal, 0

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, AnyCharacter, AnyFactionSlot, Canut
          SET_BATTLE_OR_DEATH_QUOTE FlagChapter09_KanatzBattleQuote, dialogueCh9BattleCanut, 0

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, AnyCharacter, AnyFactionSlot, Distler
          SET_BATTLE_OR_DEATH_QUOTE FlagChapter09_DistlerBattleQuote, dialogueCh9BattleDistler, 0

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, AnyCharacter, AnyFactionSlot, Mousa
          SET_BATTLE_OR_DEATH_QUOTE FlagChapter09_MousaBattleQuote, dialogueCh9BattleMousa, 0

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, AnyCharacter, AnyFactionSlot, Judas
          SET_BATTLE_OR_DEATH_QUOTE FlagChapter09_JudahBattleQuote, dialogueCh9BattleJudas, 0

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, AnyCharacter, AnyFactionSlot, Arion1
          SET_BATTLE_OR_DEATH_QUOTE FlagChapter09_ArionBattleQuote, dialogueCh9BattleArion, 0

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, AnyCharacter, AnyFactionSlot, Travant2
          SET_BATTLE_OR_DEATH_QUOTE FlagChapter09_TravantBattleQuote, dialogueCh9BattleTravant, 0
        ...
        CHECK_FLAG_SET FlagChapter09_KapathogiaSeizedCheck
          CHECK_FLAG_UNSET FlagChapter09_CoirpreCharlot_HannibalTalk
        ...
        CHECK_ALL_FLAGS_IN_LIST_SET [FlagChapter09_GrutiaSeizedCheck, FlagChapter09_CoirpreCharlot_HannibalTalk, FlagChapter09_CharlotHannibalAdjacentCheck]
    ...
    .section Chapter09EventDataSection
      ...
      aChapter09KapathogiaCastle ; 86/F898
        ...
        .structChapterCastleLocationEntry Ch09_Kapathogia, CappadociaName, [32, 17], $FC, None

      aChapter09LutheciaCastle ; 86/F8A0

        .structChapterCastleLocationEntry Ch09_Luthecia, LutetiaName, [10, 27], $FC, None

      aChapter09GrutiaCastle ; 86/F8A8

        .structChapterCastleLocationEntry Ch09_Grutia, GalatiaName, [18, 54], $FC, None
      ...
      aChapter09TalkEvents ; 86/F951
        ...
        .structChapterTalkEventEntry Chapter09, FlagChapter09_CoirpreCharlot_HannibalTalkCheck, Coirpre, Hannibal
        .structChapterTalkEventEntry Chapter09, FlagChapter09_CoirpreCharlot_HannibalTalkCheck, Charlot, Hannibal
      ...
      aFactionGroupData32 ; 86/F988
        ...
        .structFactionGroupData FactionCappadocia, BattleHUDColorDarkRed, BattleBannerThracia, None, aFactionGroupData32._Locations, aFactionGroupData32._GroupAI
      ...
      aFactionGroupData33 ; 86/F99D
        ...
        .structFactionGroupData FactionLutetia, BattleHUDColorDarkRed, BattleBannerThracia, None, aFactionGroupData33._Locations, aFactionGroupData33._GroupAI
      ...
      aFactionGroupData34 ; 86/F9B5
        ...
        .structFactionGroupData FactionGalatia, BattleHUDColorDarkRed, BattleBannerThracia, None, aFactionGroupData34._Locations, aFactionGroupData34._GroupAI
