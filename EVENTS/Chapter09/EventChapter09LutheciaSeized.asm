  ...
  aEventChapter09LutheciaSeized ; B1/D7F7
    ...
    JUMP_TRUE _NoCoirpre
      ...
      JUMP_TRUE _NoCoirpre
        ...
        +
        DIALOGUE_WITH_BG dialogueCh9SeizeLutetia_HannibalAlive, DIALOGUE_BG_HALLWAY, 3, 2
        YIELD
    ...
    _NoCoirpre ; B1/D851
    DIALOGUE_WITH_BG dialogueCh9SeizeLutetia_HannibalDead, DIALOGUE_BG_HALLWAY, 3, 2
    YIELD
