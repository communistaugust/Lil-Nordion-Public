  ...
  aEventChapter09GrutiaSeized ; B1/D97E
    ...
    JUMP_TRUE _NoAltena
      ...
      JUMP_FALSE _NoAltena
        ...
        DIALOGUE_WITH_BG dialogueCh9SeizeGalatia1_AltenaAlive, DIALOGUE_BG_HALLWAY, 3, 2
        YIELD

        JUMP +

      _NoAltena ; B1/D9AA
      DIALOGUE_WITH_BG dialogueCh9SeizeGalatia1_AltenaDead, DIALOGUE_BG_HALLWAY, 3, 2
      YIELD
