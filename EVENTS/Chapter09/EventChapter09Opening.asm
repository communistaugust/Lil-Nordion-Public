  ...
  aEventChapter09Opening ; B1/D3D6
    ...
    CASTLE_NAME $504ca0, CASLTE_NAME_RED, 100
    YIELD
    ...
    DIALOGUE_WITH_BG dialogueCh9Intro1, DIALOGUE_BG_HALLWAY, 3, 1
    YIELD
    ...
    DIALOGUE_WITH_BG dialogueCh9Intro2, DIALOGUE_BG_HALLWAY, 3, 1
    ...
    MOVE_TEMPORARY_BY_SCRIPT Travant2, [52, 43], 5, MAP_SPRITE_RED, _ScriptedMovementTravant1
    WAIT_UNIT_SPRITE_DECOMPRESSED
    ...
    CASTLE_NAME $504c80, CASLTE_NAME_RED, 90
    YIELD
    ...
    DIALOGUE_WITH_BG dialogueCh9Intro3, DIALOGUE_BG_HALLWAY, 3, 1
    YIELD
    ...
    MOVE_TEMPORARY_BY_SCRIPT Travant2, [32, 19], 5, MAP_SPRITE_RED, _ScriptedMovementTravant2
    WAIT_UNIT_SPRITE_DECOMPRESSED
    ...
    CASTLE_NAME $504c90, CASLTE_NAME_RED, 90
    YIELD

    DIALOGUE_WITH_BG dialogueCh9Intro4, DIALOGUE_BG_HALLWAY, 3, 1
    YIELD
    ...
    MOVE_TEMPORARY_BY_SCRIPT Travant2, [10, 29], 5, MAP_SPRITE_RED, _ScriptedMovementTravant3
    WAIT_UNIT_SPRITE_DECOMPRESSED
    ...
    CASTLE_NAME $504cb0, CASLTE_NAME_RED, 90
    YIELD

    DIALOGUE_WITH_BG dialogueCh9Intro5, DIALOGUE_BG_HALLWAY, 3, 1
    YIELD

    PAUSE 15
    YIELD

    MOVE_TEMPORARY_BY_SCRIPT Travant2, [18, 56], 5, MAP_SPRITE_RED, _ScriptedMovementTravant4
    WAIT_UNIT_SPRITE_DECOMPRESSED
    ...
    CASTLE_NAME $504c70, CASLTE_NAME_BLUE, 100
    YIELD

    TEST_FLAG_IN_CHAPTER_SET Chapter09, FlagChapter09_OifeyAlive
    JUMP_FALSE _OifeyDead

      DIALOGUE_WITH_BG dialogueCh9Intro6_OifeyAlive, DIALOGUE_BG_THRONE, 5, 2
      YIELD

      JUMP +

      _OifeyDead
      DIALOGUE_WITH_BG dialogueCh9Intro6_OifeyDead, DIALOGUE_BG_THRONE, 5, 2
      YIELD
    ...
    JUMP_FALSE _SkipLeifFinnTalk
      ...
      DIALOGUE_WITH_BG dialogueCh9Intro7_LeifFinnAlive, DIALOGUE_BG_GATE, 3, 3
      YIELD
