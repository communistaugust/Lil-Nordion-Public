    ...
    .weak
      ...
      FlagChapterFinal_SeliphTalkSet                    := 80
      FlagChapterFinal_LeneLayleaoverTalkSet            := 81
      FlagChapterFinal_SeliphJuliaTalked                := 82
      FlagChapterFinal_LanaMuirneJuliaLoverTalkSet      := 83
    ...
    .section ChapterFinalEventsSection
      ...
      aChapterFinalMapEvents ; B1/A3D6
        ...
        CHECK_TALK FlagChapterFinal_AltenaArionTalkCheck, Altena, Arion2
          EVENT FlagChapterFinal_AltenaArionTalk, EventChapterFinalAltenaArionTalk

        CHECK_UNIT_DIED FlagChapterFinal_HildaDiedCheck, Hilda2
          EC_NOP_00

        CHECK_UNIT_DIED FlagChapterFinal_ManfroyDiedCheck, Manfroy
          EC_NOP_00

        CHECK_UNIT_DIED FlagAlways, Arion2
        ...
        CHECK_UNIT_DIED_TO FlagChapterFinal_SeliphKilledJulius, Julius2, Seliph
          COMBATANTS_STAY_ON_MAP

        CHECK_UNIT_DIED_TO FlagChapterFinal_JuliaKilledJulius, Julius2, Julia
          COMBATANTS_STAY_ON_MAP

        CHECK_UNIT_DIED_TO FlagAlways, Julius2, AnyCharacter
          COMBATANTS_STAY_ON_MAP

        CHECK_UNIT_DIED FlagAlways, Julius2
        ...
        CHECK_CHILD_TALK FlagAlways, Fee, Seliph
         ...
         CHECK_TALK FlagAlways, Seliph, Ares
           EVENT FlagAlways, EventChapterFinalAres_SeliphTalk
        ...
        CHECK_TALK FlagAlways, Lene, Ares
         EVENT FlagAlways, EventChapterFinalLeneLaylea_AresTalk

        CHECK_TALK FlagChapterFinal_SeliphJuliaTalked, Lana, Julia
                 EVENT FlagAlways, EventChapterFinalLana_JuliaTalk

        CHECK_UNITS_FIGHTING_1TO2RANGE FlagAlways, FS_Player, Seliph, AnyFactionSlot, Julius2
          SET_PRECOMBAT_DIALOGUE FlagChapterFinal_SeliphJuliusBattleQuote, dialogueChFinalBattleJulius_Seliph, $83

        CHECK_UNITS_FIGHTING_1TO2RANGE FlagAlways, FS_Player, Julia, AnyFactionSlot, Julius2
          SET_PRECOMBAT_DIALOGUE FlagChapterFinal_JuliaJuliusBattleQuote, dialogueChFinalBattleJulius_Julia, $83

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, Iuchar, AnyFactionSlot, Brian
          SET_PRECOMBAT_DIALOGUE FlagChapterFinal_IucharBrianBattleQuote, dialogueChFinalBattleBrian_Iuchar, $46

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, Iucharba, AnyFactionSlot, Brian
          SET_PRECOMBAT_DIALOGUE FlagChapterFinal_IucharbaBrianBattleQuote, dialogueChFinalBattleBrian_Iucharba, $46

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, Tine, AnyFactionSlot, Hilda2
          SET_PRECOMBAT_DIALOGUE FlagChapterFinal_TineLinda_HildaBattleQuote, dialogueChFinalBattleHilda_TineLinda, $46

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, Linda, AnyFactionSlot, Hilda2
          SET_PRECOMBAT_DIALOGUE FlagChapterFinal_TineLinda_HildaBattleQuote, dialogueChFinalBattleHilda_TineLinda, $46

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, Arthur, AnyFactionSlot, Hilda2
          SET_PRECOMBAT_DIALOGUE FlagChapterFinal_ArthurHildaBattleQuote, dialogueChFinalBattleHilda_Arthur, $46

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, Febail, AnyFactionSlot, Scipio
          SET_PRECOMBAT_DIALOGUE FlagChapterFinal_FebailScipioBattleQuote, dialogueChFinalBattleScipio_Febail, $43

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, Lester, AnyFactionSlot, Scipio
          SET_PRECOMBAT_DIALOGUE FlagChapterFinal_LesterScipioBattleQuote, dialogueChFinalBattleScipio_Lester, $43

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, Tine, AnyFactionSlot, Ishtar3
          SET_PRECOMBAT_DIALOGUE FlagChapterFinal_TineLinda_IshtarBattleQuote, dialogueChFinalBattleIshtar_TineLinda, $46

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, Linda, AnyFactionSlot, Ishtar3
          SET_PRECOMBAT_DIALOGUE FlagChapterFinal_TineLinda_IshtarBattleQuote, dialogueChFinalBattleIshtar_TineLinda, $46

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, Seliph, AnyFactionSlot, Manfroy
          SET_PRECOMBAT_DIALOGUE FlagChapterFinal_SeliphManfroyBattleQuote, dialogueChFinalBattleManfroy_Seliph, $7A

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, Altena, AnyFactionSlot, Arion2
          SET_PRECOMBAT_DIALOGUE FlagChapterFinal_AltenaArionBattleQuote, dialogueChFinalBattleArion_Altena, $46

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, AnyCharacter, AnyFactionSlot, Robertus
          SET_BATTLE_OR_DEATH_QUOTE FlagChapterFinal_RobertoBattleQuote, dialogueChFinalBattleRobertus, 0

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, AnyCharacter, AnyFactionSlot, Boece
          SET_BATTLE_OR_DEATH_QUOTE FlagChapterFinal_BoyceBattleQuote, dialogueChFinalBattleBoece, 0

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, AnyCharacter, AnyFactionSlot, Rodin
          SET_BATTLE_OR_DEATH_QUOTE FlagChapterFinal_RodanBattleQuote, dialogueChFinalBattleRodin, 0

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, AnyCharacter, AnyFactionSlot, Uphir
          SET_BATTLE_OR_DEATH_QUOTE FlagChapterFinal_JuphielBattleQuote, dialogueChFinalBattleUphir, 0

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, AnyCharacter, AnyFactionSlot, Fisher
          SET_BATTLE_OR_DEATH_QUOTE FlagChapterFinal_FisherBattleQuote, dialogueChFinalBattleFisher, 0

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, AnyCharacter, AnyFactionSlot, Brian
          SET_BATTLE_OR_DEATH_QUOTE FlagChapterFinal_BrianBattleQuote, dialogueChFinalBattleBrian, 0

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, AnyCharacter, AnyFactionSlot, Dagan
          SET_BATTLE_OR_DEATH_QUOTE FlagChapterFinal_DagonBattleQuote, dialogueChFinalBattleDagan, 0

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, AnyCharacter, AnyFactionSlot, Hilda2
          SET_BATTLE_OR_DEATH_QUOTE FlagChapterFinal_HildaBattleQuote, dialogueChFinalBattleHilda, 0

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, AnyCharacter, AnyFactionSlot, Scipio
          SET_BATTLE_OR_DEATH_QUOTE FlagChapterFinal_ScipioBattleQuote, dialogueChFinalBattleScipio, 0

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, AnyCharacter, AnyFactionSlot, Balan
          SET_BATTLE_OR_DEATH_QUOTE FlagChapterFinal_BaranBattleQuote, dialogueChFinalBattleBalan, 0

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, AnyCharacter, AnyFactionSlot, Meng
          SET_BATTLE_OR_DEATH_QUOTE FlagChapterFinal_MengBattleQuote, dialogueChFinalBattleMeng, 0

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, AnyCharacter, AnyFactionSlot, Meabel
          SET_BATTLE_OR_DEATH_QUOTE FlagChapterFinal_MabelBattleQuote, dialogueChFinalBattleMeabel, 0

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, AnyCharacter, AnyFactionSlot, Breg
          SET_BATTLE_OR_DEATH_QUOTE FlagChapterFinal_BlegBattleQuote, dialogueChFinalBattleBreg, 0

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, AnyCharacter, AnyFactionSlot, Arion2
          SET_BATTLE_OR_DEATH_QUOTE FlagChapterFinal_ArionBattleQuote, dialogueChFinalBattleArion, 0

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, AnyCharacter, AnyFactionSlot, Ishtar3
          SET_BATTLE_OR_DEATH_QUOTE FlagChapterFinal_IshtarBattleQuote, dialogueChFinalBattleIshtar, 0

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, AnyCharacter, AnyFactionSlot, Julia
          SET_BATTLE_OR_DEATH_QUOTE FlagChapterFinal_JuliaBattleQuote, dialogueChFinalBattleJulia, 0

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, AnyCharacter, AnyFactionSlot, Manfroy
          SET_BATTLE_OR_DEATH_QUOTE FlagChapterFinal_ManfroyBattleQuote, dialogueChFinalBattleManfroy, 0

        CHECK_UNITS_FIGHTING_1TO2RANGE FlagAlways, FS_Player, AnyCharacter, AnyFactionSlot, Julius2
          SET_BATTLE_OR_DEATH_QUOTE FlagChapterFinal_JuliusBattleQuote, dialogueChFinalBattleJulius, 0
        ...
        CHECK_FLAG_UNSET FlagChapterFinal_JuliaDeathQuote
          CHECK_ALL_FLAGS_IN_LIST_SET [FlagChapterFinal_JuliaDied, FlagChapterFinal_SeliphJuliaTalkManfroyDead]
            CHECK_FLAG_UNSET FlagChapterFinal_JuliaMarried
              SET_BATTLE_OR_DEATH_QUOTE FlagChapterFinal_JuliaDeathQuote, dialogueDeathJulia, 1
        BREAK_STATE_CHECKS

        CHECK_FLAG_SET FlagChapterFinal_JuliaDied
          CHECK_FLAG_UNSET FlagChapterFinal_JuliaDeathQuote
            CHECK_FLAG_UNSET FlagChapterFinal_SeliphJuliaTalkManfroyDead
              SET_BATTLE_OR_DEATH_QUOTE FlagChapterFinal_JuliaDeathQuote, dialogueDeathJulia_Enemy, 1
        BREAK_STATE_CHECKS
        ...
        CHECK_FLAG_SET FlagChapterFinal_SeliphKilledJulius
          CHECK_FLAG_UNSET FlagChapterFinal_JuliusDeathQuote
            SET_BATTLE_OR_DEATH_QUOTE FlagChapterFinal_JuliusDeathQuote, dialogueDeathJulius_End_Seliph, 1
        BREAK_STATE_CHECKS

        CHECK_FLAG_SET FlagChapterFinal_JuliaKilledJulius
          CHECK_FLAG_UNSET FlagChapterFinal_JuliusDeathQuote
            SET_BATTLE_OR_DEATH_QUOTE FlagChapterFinal_JuliusDeathQuote, dialogueDeathJulius_End_Julia, 1
        BREAK_STATE_CHECKS
        ...
        CHECK_TURN_PHASE_AI_ACTOR AnyTurn, FS_Player
          ...
          SET_TALK_TARGET_IF_CHILDREN_MARRIED FlagChapterFinal_PattyLoverTalkSet, [Patty, Daisy], [Seliph, Seliph]
          SET_TALK_TARGET_IF_CHILDREN_MARRIED FlagChapterFinal_PattyLoverTalkSet, [Patty, Daisy], [Shannan, Shannan]
          ...
          SET_TALK_TARGET_IF_CHILDREN_MARRIED FlagChapterFinal_LanaMuirneLoverTalkSet, [Lana, Muirne], [Julia, Julia]
        ...
        CHECK_TURN_PHASE_AI_ACTOR AnyTurn, FS_Player
          CHECK_FLAG_SET FlagChapterFinal_EddaSeizedCheck
            ...
            SET_TALK_TARGET_IF_CHILDREN_MARRIED FlagChapterFinal_LeneLayleaoverTalkSet, [Lene, Laylea], [Ares, Ares]
          BREAK_STATE_CHECKS
        BREAK_TURN_EVENT_CHECKS
        ...
        CHECK_TURN_PHASE_AI_ACTOR AnyTurn, FS_Player
          CHECK_FLAG_SET FlagChapterFinal_FriegeSeizedCheck
            ...
            SET_TALK_TARGET_IF_MARRIED FlagChapterFinal_SeliphTalkSet , Seliph, Ares
    ...
    .section ChapterFinalEventDataSection
      ...
      aChapterFinalTalkEvents ; B1/AAC3
        ...
        .structChapterTalkEventEntry ChapterFinal, FlagChapterFinal_AltenaArionTalkCheck, Altena, Arion2
        .word $FFFF
      ...
      aFactionGroupData3E ; B1/AB20
        ...
        .structFactionGroupData FactionFriege2, BattleHUDColorDarkBlue, BattleBannerFriege, None, aFactionGroupData3E._Locations, aFactionGroupData3E._GroupAI
