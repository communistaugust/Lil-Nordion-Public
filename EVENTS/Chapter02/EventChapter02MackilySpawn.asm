  ...
  aEventChapter02MackilySpawn ; 8E/839D
    ...
    DIALOGUE_WITH_BG dialogueCh2SeizeInfini2, DIALOGUE_BG_HALLWAY, 3, 1
    YIELD
    ...
    DIALOGUE_WITH_BG dialogueCh2SeizeInfini3, DIALOGUE_BG_HALLWAY, 3, 1
    YIELD
    ...
    DIALOGUE_WITH_BG dialogueCh2SeizeInfini4, DIALOGUE_BG_HALLWAY, 3, 2
    YIELD
