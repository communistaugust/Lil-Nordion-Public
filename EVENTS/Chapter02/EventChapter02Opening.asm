  ...
  aEventChapter02Opening ; 8E/8000
    ...
    CASTLE_NAME $504a20, CASLTE_NAME_GREEN, 150
    YIELD

    DIALOGUE_WITH_BG dialogueCh2Intro1, DIALOGUE_BG_THRONE, 3, 2
    YIELD
    ...
    CASTLE_NAME $504a70, CASLTE_NAME_RED, 250
    WAIT_UNTIL_MAP_SPRITES_HALTING
    YIELD
    ...
    DIALOGUE_WITH_BG dialogueCh2Intro2, DIALOGUE_BG_HALLWAY, 3, 2
    YIELD
    ...
    DIALOGUE_WITH_BG dialogueCh2Intro3, DIALOGUE_BG_THRONE, 3, 1
    SET_CAMERA_POSITION [18, 44]
    YIELD
    ...
    CASTLE_NAME $504a80, CASLTE_NAME_RED, 100
    YIELD

    DIALOGUE_WITH_BG dialogueCh2Intro4, DIALOGUE_BG_HALLWAY, 3, 1
    YIELD
    ...
    _UnitList := [(HochrheinArmy9, 38)]
    _UnitList..= [(HochrheinArmy10, 40)]
    _UnitList..= [(HochrheinArmy11, 38)]
    _UnitList..= [(EliotCh02, 40)]
    ...
    CASTLE_NAME $504a30, CASLTE_NAME_BLUE, 90
    YIELD

    DIALOGUE_WITH_BG dialogueCh2Intro5, DIALOGUE_BG_THRONE, 3, 1
    YIELD
