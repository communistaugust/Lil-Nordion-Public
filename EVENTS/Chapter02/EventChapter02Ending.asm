  ...
  aEventChapter02Ending ; 8E/862C
    ...
    JUMP_FALSE _DeirdreWasntCaptured
      ...
      DIALOGUE_WITH_BG dialogueDeirdreReturns, DIALOGUE_BG_HALLWAY, 5, 2
      YIELD
    ...
    JUMP_FALSE _Continue
      ...
      DIALOGUE_WITH_BG dialogueCh2SeizeAgusti1_KnightsAlive, DIALOGUE_BG_HALLWAY, 3, 3
    ...
    _Continue ; 8E/868C
    DIALOGUE_WITH_BG dialogueCh2SeizeAgusti2, DIALOGUE_BG_HALLWAY, 3, 2
    SET_CAMERA_POSITION [45, 1]
    YIELD
