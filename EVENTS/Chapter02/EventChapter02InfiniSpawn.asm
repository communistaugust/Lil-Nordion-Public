  ...
  aEventChapter02InfiniSpawn ; 8E/8234
    ...
    DIALOGUE_WITH_BG dialogueCh2SeizeHochrhein2, DIALOGUE_BG_HALLWAY, 3, 1
    YIELD

    PAUSE 20
    YIELD

    MOVE_TEMPORARY_BY_SCRIPT Beowolf, [12, 5], 4, MAP_SPRITE_RED, _ScriptedMovementBeowolf
    WAIT_UNIT_SPRITE_DECOMPRESSED

    PAUSE 18
    YIELD

    MOVE_TEMPORARY_BY_SCRIPT Voltz, [12, 5], 4, MAP_SPRITE_RED, _ScriptedMovementVoltz
    WAIT_UNIT_SPRITE_DECOMPRESSED
    ...
    DIALOGUE dialogueCh2SeizeHochrhein3
    YIELD
    ...
    _ScriptedMovementBeowolf ; 8E/8311
    ...
    _ScriptedMovementVoltz ; 8E/8321
