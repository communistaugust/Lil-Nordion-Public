        ...
        .section Chapter01EventsSection
          ...
          aChapter01MapEvents ; 86/C8A7
            ...
            CHECK_UNIT_IN_AREA FlagChapter01_SigurdEntersForest, Sigurd, pack([12, 38]), pack([17, 43]),FS_Player
              EVENT FlagAlways, EventChapter01DeirdreSpawn

            CHECK_UNIT_IN_AREA FlagChapter01_LexOnPeninsula, Lex, pack([28, 37]), pack([28, 37]),FS_Player
            ...
            CHECK_UNIT_DIED_TO FlagAlways, EliotCh01, AnyCharacter
              COMBATANTS_STAY_ON_MAP

            CHECK_UNIT_DIED FlagAlways, EliotCh01
            ...
            CHECK_UNITS_FIGHTING FlagAlways, FS_Player, Midir, AnyFactionSlot, Munnir
              SET_PRECOMBAT_DIALOGUE FlagChapter01_MidirMunnirBattleQuote, dialogueCh1BattleMunnir_Midir, $43

            CHECK_UNITS_FIGHTING FlagAlways, FS_Player, Azelle, AnyFactionSlot, Munnir
              SET_PRECOMBAT_DIALOGUE FlagChapter01_AzelleMunnirBattleQuote, dialogueCh1BattleMunnir_Azelle, $43

            CHECK_UNITS_FIGHTING FlagAlways, FS_Player, Deirdre, AnyFactionSlot, Sandima
              SET_BATTLE_OR_DEATH_QUOTE FlagChapter01_DeirdreSandimaBattleQuote, dialogueCh1BattleSandima_Deirdre, 0

            CHECK_UNITS_FIGHTING_1TO2RANGE FlagAlways, FS_Player, Jamke, AnyFactionSlot, Sandima
              SET_PRECOMBAT_DIALOGUE FlagChapter01_JamkeSandimaBattleQuote, dialogueCh1BattleSandima_Jamke, $43

            CHECK_UNITS_FIGHTING FlagAlways, FS_Player, AnyCharacter, AnyFactionSlot, Ayra
              SET_BATTLE_OR_DEATH_QUOTE FlagChapter01_AyraBattleQuote, dialogueCh1BattleAyra, 0

            CHECK_UNITS_FIGHTING FlagAlways, FS_Player, AnyCharacter, AnyFactionSlot, Cimbaeth
              SET_BATTLE_OR_DEATH_QUOTE FlagChapter01_CimbaethBattleQuote, dialogueCh1BattleCimbaeth, 0

            CHECK_UNITS_FIGHTING FlagAlways, FS_Player, AnyCharacter, AnyFactionSlot, Munnir
              SET_BATTLE_OR_DEATH_QUOTE FlagChapter01_MunnirBattleQuote, dialogueCh1BattleMunnir, 0

            CHECK_UNITS_FIGHTING FlagAlways, FS_Player, AnyCharacter, AnyFactionSlot, EliotCh01
              SET_BATTLE_OR_DEATH_QUOTE FlagChapter01_ElliotBattleQuote, dialogueCh1BattleEliot, 0

            CHECK_UNITS_FIGHTING FlagAlways, FS_Player, AnyCharacter, AnyFactionSlot, Sandima
              SET_BATTLE_OR_DEATH_QUOTE FlagChapter01_SandimaBattleQuote, dialogueCh1BattleSandima, 0

            CHECK_UNITS_FIGHTING FlagAlways, FS_Player, AnyCharacter, AnyFactionSlot, Jamke
              SET_BATTLE_OR_DEATH_QUOTE FlagChapter01_JamkeBattleQuote, dialogueCh1BattleJamke, 0
        ...
        .section Chapter01EventDataSection
          ...
          aFactionGroupData09 ; 86/CC48
            ...
            .structFactionGroupData FactionHochrhein, BattleHUDColorWhite, BattleBannerDefault, None, None, aFactionGroupData09._GroupAI
