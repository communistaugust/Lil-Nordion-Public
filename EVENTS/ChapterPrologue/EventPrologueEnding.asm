  ...
  aEventPrologueEnding ; B1/84CD
    ...
    DIALOGUE_WITH_BG dialogueSeizeEvans1, DIALOGUE_BG_HALLWAY, 5, 2
    YIELD
    ...
    MOVE_TEMPORARY_BY_SCRIPT Aoibh, [31, 2], 4, MAP_SPRITE_GREEN, _ScriptedMovement2
    WAIT_UNIT_SPRITE_DECOMPRESSED

    MOVE_TEMPORARY_BY_SCRIPT CrossKnight2, [31, 2], 4, MAP_SPRITE_GREEN, _ScriptedMovement1
    WAIT_UNIT_SPRITE_DECOMPRESSED
    ...
    DIALOGUE_WITH_BG dialogueSeizeEvans2, DIALOGUE_BG_HALLWAY, 3, 2
