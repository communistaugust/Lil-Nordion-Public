  ...
  aEventPrologueEdainAbduction ; B1/8168
    ...
    DIALOGUE dialogueTurn1EvansPhase1
    YIELD
    ...
    DIALOGUE dialogueTurn1EvansPhase4
    YIELD
    ...
    DIALOGUE dialogueTurn1EvansPhase5
    YIELD
    ...
    DIALOGUE dialogueTurn1EvansPhase6
    YIELD
    ...
    DIALOGUE dialogueTurn1EvansPhase7
    YIELD
    ...
    DIALOGUE dialogueTurn1EvansPhase8
    YIELD
    ...
    _ScriptedBattle ; B1/82B7
      SCRIPTED_BATTLE Midir, 1, Munnir, dialogueTurn1EvansPhase2, $480e96
