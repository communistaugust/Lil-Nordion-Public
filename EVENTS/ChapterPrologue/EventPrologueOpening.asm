  ...
  aEventPrologueOpening ; B1/8000
    ...
    CASTLE_NAME $504a00, CASLTE_NAME_GREEN, 150
    ...
    DIALOGUE_WITH_BG dialogueIntro1, DIALOGUE_BG_THRONE, 3, 2
    YIELD
    ...
    CASTLE_NAME $504a10, CASLTE_NAME_BLUE, 110
    YIELD

    DIALOGUE_WITH_BG dialogueIntro2, DIALOGUE_BG_THRONE, 3, 1
    YIELD
