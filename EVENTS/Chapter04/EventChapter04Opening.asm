  ...
  aEventChapter04Opening ; 8E/9020
    ...
    EVENT_3B $80
    FADE_IN_BY_TIMER 3
    CASTLE_NAME $504b10, CASLTE_NAME_YELLOW, 120
    YIELD
    ...
    CASTLE_NAME $504ae0, CASLTE_NAME_BLUE, 90
    YIELD
    ...
    JUMP_FALSE _LewynDead
      ...
      JUMP_FALSE _ErinysDead
        ...
        DIALOGUE_WITH_BG dialogueCh4Intro1_LewynErinysAlive, DIALOGUE_BG_THRONE, 3, 2
        YIELD
        JUMP +

      _ErinysDead ; 8E/906D
      DIALOGUE_WITH_BG dialogueCh4Intro1_ErinysDead, DIALOGUE_BG_THRONE, 3, 2
      YIELD
      JUMP +

    _LewynDead ; 8E/9078
    DIALOGUE_WITH_BG dialogueCh4Intro1_LewynDead, DIALOGUE_BG_THRONE, 3, 2
    YIELD
    ...
    DIALOGUE_WITH_BG dialogueCh4Intro2_AllPresent, DIALOGUE_BG_THRONE, 3, 3
    YIELD
    ...
    DIALOGUE_WITH_BG dialogueCh4Intro2_FinnDead, DIALOGUE_BG_THRONE, 3, 3
    YIELD
    ...
    DIALOGUE_WITH_BG dialogueCh4Intro2_FinnAlone, DIALOGUE_BG_THRONE, 3, 3
    YIELD
    ...
    CASTLE_NAME $504af0, CASLTE_NAME_RED, 120
    YIELD
    ...
    DIALOGUE_WITH_BG dialogueCh4Intro3, DIALOGUE_BG_HALLWAY, 3, 1
    YIELD
