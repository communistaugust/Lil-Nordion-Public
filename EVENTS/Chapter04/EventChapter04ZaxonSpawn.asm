  ...
  aEventChapter04ZaxonSpawn ; 8E/96C2
    ...
    DIALOGUE_WITH_BG dialogueCh4SilesseSeized2, DIALOGUE_BG_HALLWAY, 3, 1
    YIELD
    ...
    DIALOGUE_WITH_BG dialogueCh4SilesseSeized3, DIALOGUE_BG_THRONE, 3, 2
    ...
    DIALOGUE_WITH_BG dialogueCh4SilesseSeized4, DIALOGUE_BG_THRONE, 3, 2
    YIELD
    ...
    DIALOGUE_WITH_BG dialogueCh4SilesseSeized5, DIALOGUE_BG_HALLWAY, 3, 1
    YIELD
