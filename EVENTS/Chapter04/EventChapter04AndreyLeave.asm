  ...
  aEventChapter04AndreyLeave ; 8E/95F6
    ...
    DIALOGUE dialogueCh4SilesseSeized1
    YIELD
    ...
    .rept 8
      ...
      FILL_EVENT_UNIT_SLOT Beigeritter1, EventUnitSlot1
      MOVE_TEMPORARY_TO_COORDS Beigeritter1, [-1, -1], [63, 45], 4, EventUnitSlot1, MAP_SPRITE_RED, true, true
      WAIT_UNIT_SPRITE_DECOMPRESSED

      RUN_EVENT_CONDITION
        REMOVE_UNIT Beigeritter1
