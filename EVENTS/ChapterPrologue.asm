    ...
    .section ChapterPrologueEventsSection
      ...
      aChapterPrologueMapEvents ; 90/8046
        ...
        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, Midir, AnyFactionSlot, Gerald
          SET_PRECOMBAT_DIALOGUE FlagPrologue_MidirGerrardBattleQuote, dialogueBattleGerald_Midir, $43

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, AnyCharacter, AnyFactionSlot, DiMaggio
          SET_BATTLE_OR_DEATH_QUOTE FlagPrologue_DiMaggioBattleQuote, dialogueBattleDiMaggio, 0

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, AnyCharacter, AnyFactionSlot, Gerald
          SET_BATTLE_OR_DEATH_QUOTE FlagPrologue_GerrardBattleQuote, dialogueBattleGerald, 0

        CHECK_UNIT_DIED_TO FlagPrologue_MidirCutsceneDeath, Midir, AnyCharacter
          SET_BATTLE_OR_DEATH_QUOTE FlagAlways, dialogueTurn1EvansPhase3, 1
    ...
    .section ChapterPrologueEventDataSection
      ...
      aFactionGroupData03 ; 90/828E
        ...
        .structFactionGroupData $FF, BattleHUDColorDarkBlue, BattleBannerFriege, None, None, aFactionGroupData03._GroupAI
