    ...
    .section Chapter04EventsSection
      ...
      aChapter04MapEvents ; 86/D875
        ...
        CHECK_UNIT_DIED FlagChapter04_DecairDied, Decair
          EC_NOP_00
        ...
        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, Lewyn, AnyFactionSlot, Myos
          SET_PRECOMBAT_DIALOGUE FlagChapter04_LewynMyosBattleQuote, dialogueCh4BattleMyos_Lewyn, $43

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, Lewyn, AnyFactionSlot, Decair
          SET_PRECOMBAT_DIALOGUE FlagChapter04_LewynDaccarBattleQuote, dialogueCh4BattleDecair_Lewyn, $43

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, Erinys, AnyFactionSlot, Dithorba
          SET_PRECOMBAT_DIALOGUE FlagChapter04_ErinysDithorbaBattleQuote, dialogueCh4BattleDithorba_Erinys, $43

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, Erinys, AnyFactionSlot, Pamela
          SET_PRECOMBAT_DIALOGUE FlagChapter04_ErinysPamelaBattleQuote, dialogueCh4BattlePamela_Erinys, $43

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, Lewyn, AnyFactionSlot, Pamela
          SET_PRECOMBAT_DIALOGUE FlagChapter04_LewynPamelaBattleQuote, dialogueCh4BattlePamela_Lewyn, $43

        CHECK_UNITS_FIGHTING_1TO2RANGE FlagAlways, FS_Player, AnyCharacter, AnyFactionSlot, Kabeiri
          SET_BATTLE_OR_DEATH_QUOTE FlagChapter04_CuvuliBattleQuote, dialogueCh4BattleKabeiri, 0

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, AnyCharacter, AnyFactionSlot, Dithorba
          SET_BATTLE_OR_DEATH_QUOTE FlagChapter04_DithorbaBattleQuote, dialogueCh4BattleDithorba, 0

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, AnyCharacter, AnyFactionSlot, Myos
          SET_BATTLE_OR_DEATH_QUOTE FlagChapter04_MyosBattleQuote, dialogueCh4BattleMyos, 0

        CHECK_UNITS_FIGHTING FlagAlways, FS_Ch04Zaxon, AnyCharacter, AnyFactionSlot, Annand
          SET_BATTLE_OR_DEATH_QUOTE FlagChapter04_AnnandZaxonBattleQuote, dialogueCh4BattleAnnand, 0

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, AnyCharacter, AnyFactionSlot, Pamela
          SET_BATTLE_OR_DEATH_QUOTE FlagChapter04_PamelaBattleQuote, dialogueCh4BattlePamela, 0

        CHECK_UNITS_FIGHTING FlagAlways, FS_Ch04Silesse, AnyCharacter, AnyFactionSlot, AndreyCh04
          SET_BATTLE_OR_DEATH_QUOTE FlagChapter04_AndreySilesseBattleQuote, dialogueCh4BattleAndrey, 0

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, AnyCharacter, AnyFactionSlot, Donovan
          SET_BATTLE_OR_DEATH_QUOTE FlagChapter04_DonovanBattleQuote, dialogueCh4BattleDonovan, 0

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, AnyCharacter, AnyFactionSlot, Decair
          SET_BATTLE_OR_DEATH_QUOTE FlagChapter04_DaccarBattleQuote, dialogueCh4BattleDecair, 0

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, AnyCharacter, AnyFactionSlot, Lamia
          SET_BATTLE_OR_DEATH_QUOTE FlagChapter04_LamiaBattleQuote, dialogueCh4BattleLamia, 0
        ...
        CHECK_TURN_PHASE_AI_ACTOR AnyTurn, FS_Ch04Zaxon
          CHECK_FLAG_SET FlagChapter04_SilesseSeized
            CHECK_FLAG_UNSET FlagChapter04_DecairDied
    ...
    .section Chapter04EventDataSection
      ...
      aChapter04SailaneCastle ; 86/DC9C
        ...
        .structChapterCastleLocationEntry Ch04_Sailane, SeirenName, [5, 39], $FC, aChapter04ShopData
