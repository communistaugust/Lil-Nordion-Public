  ...
  aEventChapter03OrgahilSpawn ; 9D/8D1C
    ...
    DIALOGUE_WITH_BG dialogueCh3SeizeSylvale2, DIALOGUE_BG_HALLWAY, 3, 2
    YIELD
    ...
    MOVE_TEMPORARY_BY_SCRIPT Pisear, [52, 6], 4, MAP_SPRITE_RED, _ScriptedMovementPisear
    WAIT_UNIT_SPRITE_DECOMPRESSED

    PAUSE 16
    YIELD

    MOVE_TEMPORARY_BY_SCRIPT Dobar, [52, 6], 4, MAP_SPRITE_RED, _ScriptedMovementDobar
    WAIT_UNIT_SPRITE_DECOMPRESSED
    ...
    DIALOGUE dialogueCh3SeizeSylvale3
    YIELD
    ...
    DIALOGUE dialogueCh3SeizeSylvale4
    YIELD
    ...
    _ScriptedMovementDobar ; 9D/8ED8
      MAP_DOWN_MULTIPLE 3
    ...
    _ScriptedMovementPisear ; 9D/8EE2
      MAP_DOWN_MULTIPLE 3
