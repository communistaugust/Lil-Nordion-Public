  ...
  aEventChapter03SylvaleSpawn ; 9D/8958
    ...
    DIALOGUE_WITH_BG dialogueCh3SeizeMadino5, DIALOGUE_BG_HALLWAY, 3, 2
    YIELD
    ...
    DIALOGUE dialogueCh3SeizeMadino6
    YIELD
    ...
    DIALOGUE_WITH_BG dialogueCh3SeizeMadino7, DIALOGUE_BG_HALLWAY, 3, 2
    YIELD
