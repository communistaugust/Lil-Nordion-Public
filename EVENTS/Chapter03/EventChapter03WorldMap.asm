  ...
  aEventChapter03WorldMap ; 8D/FD80
    ...
    WM_MARKER [204, 108], WMM_Slot0, 06
    WM_DIALOGUE dialogueCh3WM1
    YIELD
    ...
    WM_DIALOGUE dialogueCh3WM3
    YIELD

    WM_DIALOGUE dialogueCh3WM4
    YIELD
