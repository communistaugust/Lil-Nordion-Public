  ...
  aEventChapter03MadinoSeized ; 9D/87A5
    ...
    DIALOGUE_WITH_BG dialogueCh3SeizeMadino1, DIALOGUE_BG_HALLWAY, 3, 2
    ...
    DIALOGUE_WITH_BG dialogueCh3SeizeMadino2, DIALOGUE_BG_HALLWAY, 3, 1
    YIELD
    ...
    DIALOGUE_WITH_BG dialogueCh3SeizeMadino3, DIALOGUE_BG_THRONE, 3, 1
    ...
    DIALOGUE dialogueCh3SeizeMadino4
    YIELD
