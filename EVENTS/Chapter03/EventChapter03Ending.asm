  ...
  aEventChapter03Ending ; 9D/8EEC
    ...
    DIALOGUE_WITH_BG dialogueCh3SeizeOrgahil1, DIALOGUE_BG_HALLWAY, 5, 2
    ...
    DIALOGUE dialogueCh3SeizeOrgahil2
    YIELD
    ...
    DIALOGUE dialogueCh3SeizeOrgahil3
    YIELD
    ...
    DIALOGUE_WITH_BG dialogueCh3SeizeOrgahil4, DIALOGUE_BG_HALLWAY, 3, 2
    YIELD
    ...
    DIALOGUE_WITH_BG dialogueCh3SeizeOrgahil5, DIALOGUE_BG_HALLWAY, 3, 3
    SET_CAMERA_POSITION [44, 0]
    YIELD
