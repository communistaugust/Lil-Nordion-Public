  ...
  aEventChapter05Ending ; 9D/C59E
    ...
    DIALOGUE dialogueCh5TalkSigurdAida
    YIELD
    ...
    DIALOGUE dialogueCh5BattleOfBelhalla1
    YIELD
    ...
    DIALOGUE dialogueCh5BattleOfBelhalla2
    YIELD
    ...
    DIALOGUE dialogueCh5BattleOfBelhalla3
    YIELD
    JUMP +
    ...
    eventLoadAliveUnitsNearVelthomer ; 9D/C799
      ...
      _PlayerAtVelthomer..= [(FlagChapter05EndAlive_Beowolf , Beowolf,  [23, 45])]
    ...
    _PlayerAtBelhalla2..= [(FlagChapter05EndAlive_Beowolf,   Beowolf,  [7, 45])]
