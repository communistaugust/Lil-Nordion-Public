  ...
  aEventChapter05PhinoraSeized ; 9D/C468
    ...
    DIALOGUE_WITH_BG dialogueCh5SeizeFionnuala1, DIALOGUE_BG_HALLWAY, 3, 2
    YIELD
    ...
    DIALOGUE dialogueCh5KillQuan_EthlynDead
    YIELD
    ...
    DIALOGUE dialogueCh5SeizeFionnuala2
    YIELD
    ...
    DIALOGUE_WITH_BG dialogueCh5SeizeFionnuala3, DIALOGUE_BG_HALLWAY, 3, 2
    YIELD
    ...
    DIALOGUE dialogueCh5SeizeFionnuala4
    YIELD
