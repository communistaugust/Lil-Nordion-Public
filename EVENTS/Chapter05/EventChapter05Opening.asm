  ...
  aEventChapter05Opening ; 9D/BEBB
    ...
    CASTLE_NAME $504bc0, CASLTE_NAME_RED, 150

    MOVE_TEMPORARY_BY_SCRIPT Slade, [63, 8], 4, MAP_SPRITE_RED, _ScriptedMovementSlade
    WAIT_UNIT_SPRITE_DECOMPRESSED
    ...
    DIALOGUE_WITH_BG dialogueCh5Intro2, DIALOGUE_BG_HALLWAY, 3, 2
    YIELD
    ...
    DIALOGUE_WITH_BG dialogueCh5Intro3, DIALOGUE_BG_HALLWAY, 3, 1
    YIELD
    ...
    DIALOGUE_WITH_BG dialogueCh5Intro4, DIALOGUE_BG_HALLWAY, 3, 1
    YIELD
    ...
    CASTLE_NAME $504b00, CASLTE_NAME_BLUE, 90
    YIELD

    DIALOGUE_WITH_BG dialogueCh5Intro5, DIALOGUE_BG_THRONE, 3, 1
    YIELD
    ...
    _ScriptedMovementSlade ; 9D/C0C2
      MAP_LEFT_MULTIPLE 8
      MAP_FACE_UP
      MAP_PAUSE 10
      MAP_END
