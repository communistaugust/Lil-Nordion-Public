  ...
  aEventChapter07DalvinTristanAdjacent ; B2/918A
    ...
    JUMP_FALSE _End
      ...
      PLAY_SFX_WORD $7FF7
      DIALOGUE dialogueCh7TristanWaitsNextToDalvin1
      YIELD

      RUN_ASM rlASMCDalvinTristanFightRound1
      YIELD

      DIALOGUE dialogueCh7TristanWaitsNextToDalvin2
      YIELD

      RUN_ASM rlASMCDalvinTristanFightRound2
      YIELD

      DIALOGUE dialogueCh7TristanWaitsNextToDalvin3
      YIELD
      ...
      RUN_EVENT_CONDITION
              MODIFY_LOVE_POINTS Tristan, Dalvin, 100
      PLAY_SFX_WORD $00E8
