  ...
  aEventChapter07UlsterSpawn ; B2/8CA3
    ...
    DIALOGUE_WITH_BG dialogueCh7SeizeMergen2, DIALOGUE_BG_HALLWAY, 3, 2
    YIELD
    ...
    DIALOGUE_WITH_BG dialogueCh7SeizeMergen3, DIALOGUE_BG_GATE, 3, 2
    YIELD
    ...
    DIALOGUE_WITH_BG dialogueCh7SeizeMergen4, DIALOGUE_BG_HALLWAY, 3, 2
    YIELD
    ...
    DIALOGUE_WITH_BG dialogueCh7SeizeMergen5, DIALOGUE_BG_HALLWAY, 3, 1
    YIELD
