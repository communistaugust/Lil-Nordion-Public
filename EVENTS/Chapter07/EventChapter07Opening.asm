  ...
  aEventChapter07Opening ; B2/87DC
    ...
    CASTLE_NAME $504b70, CASLTE_NAME_GREEN, 130
    YIELD

    DIALOGUE_WITH_BG dialogueCh7Intro1, DIALOGUE_BG_THRONE, 3, 2
    YIELD
    ...
    CASTLE_NAME $504bb0, CASLTE_NAME_RED, 90
    YIELD

    DIALOGUE_WITH_BG dialogueCh7Intro2, DIALOGUE_BG_HALLWAY, 3, 2
    YIELD
    ...
    CASTLE_NAME $504c10, CASLTE_NAME_RED, 90
    YIELD
    ...
    DIALOGUE_WITH_BG dialogueCh7Intro5, DIALOGUE_BG_HALLWAY, 3, 2
    YIELD
    ...
    CASTLE_NAME $504bf0, CASLTE_NAME_BLUE, 90
    YIELD

    DIALOGUE_WITH_BG dialogueCh7Intro6, DIALOGUE_BG_THRONE, 3, 1
    YIELD
