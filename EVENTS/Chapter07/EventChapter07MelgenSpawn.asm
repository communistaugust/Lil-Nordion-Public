  ...
  aEventChapter07MelgenSpawn ; B2/8B71
    ...
    DIALOGUE_WITH_BG dialogueCh7SeizeAed2, DIALOGUE_BG_HALLWAY, 3, 2
    ...
    CASTLE_NAME $504ba0, CASLTE_NAME_RED, 90
    YIELD
    ...
    DIALOGUE_WITH_BG dialogueCh7SeizeAed3, DIALOGUE_BG_HALLWAY, 3, 1
    YIELD
