  ...
  aEventChapterFinalOpening ; B1/DD63
    ...
    FADE_IN_BY_TIMER 5
    CASTLE_NAME $504b20, CASLTE_NAME_RED, 150
    YIELD

    DIALOGUE_WITH_BG dialogueChFinalIntro1, DIALOGUE_BG_HALLWAY, 3, 2
    YIELD
    ...
    CASTLE_NAME $504B60, CASLTE_NAME_RED, 100
    YIELD
    ...
    DIALOGUE_WITH_BG dialogueChFinalIntro2, DIALOGUE_BG_HALLWAY, 5, 2
    YIELD
    ...
    CASTLE_NAME $504a10, CASLTE_NAME_BLUE, 120
    YIELD

    DIALOGUE_WITH_BG dialogueChFinalIntro3, DIALOGUE_BG_THRONE, 3, 2
    YIELD
