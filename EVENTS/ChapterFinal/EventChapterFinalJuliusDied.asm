  ...
  aEventChapterFinalJuliusDied ; B1/E7F4
    ...
    FACTION_UNIT_DEATH FS_ChFinalBelhalla, AnyAI, Julius2
    YIELD
    ...
    .for _AI in _AIList
      ...
      FACTION_UNIT_DEATH FS_ChFinalBelhalla, _AI
      YIELD
    ...
    JUMP_TRUE _ManfroyDead
      ...
      DIALOGUE dialogueChFinalKillJulius1_ManfroyAlive
      YIELD
    ...
    DIALOGUE dialogueChFinalKillJulius2_ManfroyAlive_JuliaAlive
    YIELD
