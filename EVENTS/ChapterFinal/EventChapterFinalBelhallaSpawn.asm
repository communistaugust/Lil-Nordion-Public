  ...
  aEventChapterFinalBelhallaSpawn ; B1/E2E5
    ...
    CASTLE_NAME $504b40, CASLTE_NAME_RED, 90
    YIELD
    ...
    DIALOGUE_WITH_BG dialogueChFinalSeizeFriege2, DIALOGUE_BG_HALLWAY, 3, 2
    YIELD
    ...
    DIALOGUE_WITH_BG dialogueChFinalSeizeFriege3, DIALOGUE_BG_HALLWAY, 3, 1
    YIELD
