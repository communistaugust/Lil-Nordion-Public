  ...
  aEventChapter08MeathSpawn ; 8F/BC5C
    ...
    DIALOGUE_WITH_BG dialogueCh8SeizeConnacht2, DIALOGUE_BG_HALLWAY, 3, 1
    YIELD
    ...
    DIALOGUE_WITH_BG dialogueCh8SeizeConnacht3, DIALOGUE_BG_HALLWAY, 3, 1
    YIELD
    ...
    DIALOGUE_WITH_BG dialogueCh8SeizeConnacht4, DIALOGUE_BG_GATE, 3, 2
    YIELD
