  ...
  aEventChapter08Ending ; 8F/BE4B
    ...
    JUMP_FALSE +
      ...
      DIALOGUE_WITH_BG dialogueJuliaReturns, DIALOGUE_BG_HALLWAY, 5, 2
      YIELD
    ...
    +
    DIALOGUE_WITH_BG dialogueCh8SeizeMeath1, DIALOGUE_BG_HALLWAY, 3, 2
    ...
    JUMP_TRUE _End
      ...
      DIALOGUE dialogueCh8SeizeMeath2
      YIELD
