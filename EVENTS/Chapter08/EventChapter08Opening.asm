  ...
  aEventChapter08Opening ; 8F/B81D
    ...
    CASTLE_NAME $504b80, CASLTE_NAME_RED, 180
    YIELD

    DIALOGUE_WITH_BG dialogueCh8Intro1, DIALOGUE_BG_HALLWAY, 3, 2
    YIELD
    ...
    CASTLE_NAME $504b90, CASLTE_NAME_RED, 90
    YIELD

    DIALOGUE_WITH_BG dialogueCh8Intro2, DIALOGUE_BG_FOUNTAIN, 3, 2
    YIELD
    ...
    CASTLE_NAME $504c70, CASLTE_NAME_RED, 90
    YIELD

    DIALOGUE_WITH_BG dialogueCh8Intro3, DIALOGUE_BG_HALLWAY, 3, 1
    YIELD
    ...
    CASTLE_NAME $504bb0, CASLTE_NAME_BLUE, 90
    YIELD

    DIALOGUE_WITH_BG dialogueCh8Intro4, DIALOGUE_BG_THRONE, 3, 1
    YIELD
