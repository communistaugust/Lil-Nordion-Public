    ...
    .weak
      ...
      FlagChapter02_BeowolfTalkSuccess          := 27
      ...
      FlagChapter02_BeowolfTalkNoMoney          := 47
    ...
    .section Chapter02EventsSection
      ...
      aChapter02MapEvents ; 86/CD5E
        ...
        CHECK_TALK FlagChapter02_BeowolfTalkSuccess, AnyCharacter, Beowolf, 1
          EVENT FlagAlways, EventChapter02BeowulfTalkSuccess

        CHECK_TALK FlagChapter02_BeowolfTalkNoMoney, AnyCharacter, Beowolf
        ...
        CHECK_TALK FlagAlways, Beowolf, Lachesis
        ...
        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, Lewyn, AnyFactionSlot, Erinys
          SET_BATTLE_OR_DEATH_QUOTE FlagChapter02_LewynErinysBattleQuote, dialogueCh2BattleErinys_Lewyn, 0

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, Erinys, AnyFactionSlot, ChagallCh02
          SET_PRECOMBAT_DIALOGUE FlagChapter02_ErinysChagallBattleQuote, dialogueCh2BattleChagall_Erinys, $46

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, Lachesis, AnyFactionSlot, ChagallCh02
          SET_PRECOMBAT_DIALOGUE FlagChapter02_LachesisChagallBattleQuote, dialogueCh2BattleChagall_Lachesis, $46

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, Lachesis, AnyFactionSlot, EliotCh02
          SET_PRECOMBAT_DIALOGUE FlagChapter02_LachesisElliotBattleQuote, dialogueCh2BattleEliot_Lachesis, $43

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, Beowolf, AnyFactionSlot, Voltz
          SET_PRECOMBAT_DIALOGUE FlagChapter02_BeowulfWaltzBattleQuote, dialogueCh2BattleVoltz_Beowolf, $43

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, Lewyn, AnyFactionSlot, MacBeth
          SET_PRECOMBAT_DIALOGUE FlagChapter02_LewynMacBethBattleQuote, dialogueCh2BattleMacbeth_Lewyn, $43

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, AnyCharacter, AnyFactionSlot, EliotCh02
          SET_BATTLE_OR_DEATH_QUOTE FlagChapter02_ElliotBattleQuote, dialogueCh2BattleEliot, 0

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, AnyCharacter, AnyFactionSlot, Philip
          SET_BATTLE_OR_DEATH_QUOTE FlagChapter02_PhilipBattleQuote, dialogueCh2BattlePhilip, 0

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, AnyCharacter, AnyFactionSlot, Bordeaux
          SET_BATTLE_OR_DEATH_QUOTE FlagChapter02_BordeauxBattleQuote, dialogueCh2BattleBordeaux, 0

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, AnyCharacter, AnyFactionSlot, MacBeth
          SET_BATTLE_OR_DEATH_QUOTE FlagChapter02_MacBethBattleQuote, dialogueCh2BattleMacbeth, 0

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, AnyCharacter, AnyFactionSlot, Voltz
          SET_BATTLE_OR_DEATH_QUOTE FlagChapter02_WaltzBattleQuote, dialogueCh2BattleVoltz, 0

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, AnyCharacter, AnyFactionSlot, Beowolf
          SET_BATTLE_OR_DEATH_QUOTE FlagChapter02_BeowulfBattleQuote, dialogueCh2BattleBeowolf, 0

        CHECK_UNITS_FIGHTING_1TO2RANGE FlagAlways, FS_Player, AnyCharacter, AnyFactionSlot, Clement
          SET_BATTLE_OR_DEATH_QUOTE FlagChapter02_ClementBattleQuote, dialogueCh2BattleClement, 0

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, AnyCharacter, AnyFactionSlot, Zayin
          SET_BATTLE_OR_DEATH_QUOTE FlagChapter02_ZaneBattleQuote, dialogueCh2BattleZayin, 0

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, AnyCharacter, AnyFactionSlot, Erinys
          SET_BATTLE_OR_DEATH_QUOTE FlagChapter02_ErinysBattleQuote, dialogueCh2BattleErinys, 0

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, AnyCharacter, AnyFactionSlot, ChagallCh02
          SET_BATTLE_OR_DEATH_QUOTE FlagChapter02_ChagallBattleQuote, dialogueCh2BattleChagall, 0
        ...
        CHECK_ALL_FLAGS_IN_LIST_SET [FlagChapter02_AgustiSeized, FlagChapter02_LachesisRecruitment]
          CHECK_UNIT_ALIVE Lachesis
            CHECK_UNIT_ALIVE Aoibh
              CHECK_UNIT_ALIVE Aoife
                CHECK_UNIT_ALIVE Ailbhe
    ...
    .section Chapter02EventDataSection
      ...
      aChapter02HeirheinCastle ; 86/D187
        ...
        .structChapterCastleLocationEntry Ch02_Heirhein, HochrheinName, [5, 32], $FC, None
      ...
      aChapter02MackilyCastle ; 86/D197
        ...
        .structChapterCastleLocationEntry Ch02_Mackily, MakariyName, [43, 29], $FC, None
      ...
      aFactionGroupData0C ; 86/D250
        ...
        .structFactionGroupData FactionHochrhein, BattleHUDColorWhite, BattleBannerDefault, None, aFactionGroupData0C._Locations, aFactionGroupData0C._GroupAI
      ...
      aFactionGroupData0E ; 86/D286
        ...
        .structFactionGroupData FactionMakariy, BattleHUDColorWhite, BattleBannerDefault, None, aFactionGroupData0E._Locations, aFactionGroupData0E._GroupAI
      ...
      aChapter02TalkEvents ; 86/D2BF
        ...
        .structChapterTalkEventEntry Chapter02, FlagChapter02_BeowolfTalkSuccess, AnyCharacter, Beowolf, true
        .structChapterTalkEventEntry Chapter02, FlagChapter02_BeowolfTalkNoMoney, AnyCharacter, Beowolf
