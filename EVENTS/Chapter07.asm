    ...
    .weak
      ...
      FlagChapter07_RaisaBattleQuote                 := 25
      ...
      FlagChapter07_RaisaDied                        := 50
      FlagChapter07_IshtoreDied                     := 51
      FlagChapter07_IshtoreDeathQuoteRaisaAlive      := 52
    ...
    .section Chapter07EventsSection
      ...
      aChapter07MapEvents ; 86/E764
        ...
        CHECK_UNIT_DIED FlagChapter07_RaisaDied, Raisa
          EC_NOP_00
        ...
        CHECK_UNIT_DIED_TO FlagAlways, Banba1, AnyCharacter
          COMBATANTS_STAY_ON_MAP

        CHECK_UNIT_DIED FlagAlways, Banba1
          EVENT FlagAlways, EventChapter07BanbaDied

        CHECK_UNIT_DIED_TO FlagAlways, Fodla1, AnyCharacter
          COMBATANTS_STAY_ON_MAP

        CHECK_UNIT_DIED FlagAlways, Fodla1
          EVENT FlagAlways, EventChapter07FotlaDied

        CHECK_UNIT_DIED_TO FlagAlways, Eriu1, AnyCharacter
          COMBATANTS_STAY_ON_MAP

        CHECK_UNIT_DIED FlagAlways, Eriu1
          EVENT FlagAlways, EventChapter07EriuDied

        CHECK_UNIT_DIED_TO FlagAlways, Bloom, AnyCharacter
          COMBATANTS_STAY_ON_MAP

        CHECK_UNIT_DIED FlagAlways, Bloom
        ...
        CHECK_TALK FlagChapter07_DahnaArmyTalkCheck, AnyCharacter, DahnaArmy1
        ...
        CHECK_SPECIAL_CRIT FlagAlways, 3, Banba1
          SET_BATTLE_OR_DEATH_QUOTE FlagChapter07_BanbaTriangleAttackQuote, dialogueCh7BattleBanba_TriangleAttack, 0

        CHECK_SPECIAL_CRIT FlagAlways, 3, Fodla1
          SET_BATTLE_OR_DEATH_QUOTE FlagChapter07_FotlaTriangleAttackQuote, dialogueCh7BattleFodla_TriangleAttack, 0

        CHECK_SPECIAL_CRIT FlagAlways, 3, Eriu1
          SET_BATTLE_OR_DEATH_QUOTE FlagChapter07_EriuTriangleAttackQuote, dialogueCh7BattleEriu_TriangleAttack, 0

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, Arthur, AnyFactionSlot, Tine
          SET_PRECOMBAT_DIALOGUE FlagChapter07_ArthurAmid_TineLindaBattleQuote, dialogueCh7BattleTineLinda_ArthurAmid, $43
        ...
        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, Ares, AnyFactionSlot, Bramsel
          SET_PRECOMBAT_DIALOGUE FlagChapter07_AresBramselBattleQuote, dialogueCh7BattleBramsel_Ares, $43

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, Ares, AnyFactionSlot, Javarro
          SET_PRECOMBAT_DIALOGUE FlagChapter07_AresJavarroBattleQuote, dialogueCh7BattleJavarro_Ares, $43

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, Tine, AnyFactionSlot, Bloom
          SET_PRECOMBAT_DIALOGUE FlagChapter07_TineLinda_BloomBattleQuote, dialogueCh7BattleBloom_TineLinda, $46

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, Linda, AnyFactionSlot, Bloom
          SET_PRECOMBAT_DIALOGUE FlagChapter07_TineLinda_BloomBattleQuote, dialogueCh7BattleBloom_TineLinda, $46

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, Arthur, AnyFactionSlot, Bloom
          SET_PRECOMBAT_DIALOGUE FlagChapter07_ArthurAmid_BloomBattleQuote, dialogueCh7BattleBloom_ArthurAmid, $46

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, Amid, AnyFactionSlot, Bloom
          SET_PRECOMBAT_DIALOGUE FlagChapter07_ArthurAmid_BloomBattleQuote, dialogueCh7BattleBloom_ArthurAmid, $46

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, Leif, AnyFactionSlot, Bloom
          SET_PRECOMBAT_DIALOGUE FlagChapter07_LeifBloomBattleQuote, dialogueCh7BattleBloom_Leif, $46
        ...
        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, AnyCharacter, AnyFactionSlot, Kutuzov
          SET_BATTLE_OR_DEATH_QUOTE FlagChapter07_KutuzovBattleQuote, dialogueCh7BattleKutuzov, 0

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, AnyCharacter, AnyFactionSlot, Kutuzov2
          SET_BATTLE_OR_DEATH_QUOTE FlagChapter07_KutuzovBattleQuote, dialogueCh7BattleKutuzov, 0

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, AnyCharacter, AnyFactionSlot, Raisa
          SET_BATTLE_OR_DEATH_QUOTE FlagChapter07_RaisaBattleQuote, dialogueCh7BattleRaisa, 0

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, AnyCharacter, AnyFactionSlot, Javarro
          SET_BATTLE_OR_DEATH_QUOTE FlagChapter07_JavarroBattleQuote, dialogueCh7BattleJavarro, 0

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, AnyCharacter, AnyFactionSlot, Bramsel
          SET_BATTLE_OR_DEATH_QUOTE FlagChapter07_BramselBattleQuote, dialogueCh7BattleBramsel, 0

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, AnyCharacter, AnyFactionSlot, Banba1
          SET_BATTLE_OR_DEATH_QUOTE FlagChapter07_BanbaBattleQuote, dialogueCh7BattleBanba, 0

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, AnyCharacter, AnyFactionSlot, Fodla1
          SET_BATTLE_OR_DEATH_QUOTE FlagChapter07_FotlaBattleQuote, dialogueCh7BattleFodla, 0

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, AnyCharacter, AnyFactionSlot, Eriu1
          SET_BATTLE_OR_DEATH_QUOTE FlagChapter07_EriuBattleQuote, dialogueCh7BattleEriu, 0

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, AnyCharacter, AnyFactionSlot, Tine
          SET_BATTLE_OR_DEATH_QUOTE FlagChapter07_TineLinda_BattleQuote, dialogueCh7BattleTineLinda, 0

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, AnyCharacter, AnyFactionSlot, Linda
          SET_BATTLE_OR_DEATH_QUOTE FlagChapter07_TineLinda_BattleQuote, dialogueCh7BattleTineLinda, 0

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, AnyCharacter, AnyFactionSlot, Bloom
          SET_BATTLE_OR_DEATH_QUOTE FlagChapter07_BloomBattleQuote, dialogueCh7BattleBloom, 0
        ...
        CHECK_FLAG_UNSET FlagChapter07_IshtoreBattleQuote
          CHECK_FLAG_SET FlagChapter07_IshtoreBattleQuoteCheck
            CHECK_FLAG_UNSET FlagChapter07_RaisaDied
              SET_BATTLE_OR_DEATH_QUOTE FlagChapter07_IshtoreBattleQuote, dialogueCh7BattleIshtore, 0
        BREAK_STATE_CHECKS

        CHECK_FLAG_UNSET FlagChapter07_IshtoreBattleQuote
          CHECK_FLAG_SET FlagChapter07_IshtoreBattleQuoteCheck
            CHECK_FLAG_SET FlagChapter07_RaisaDied
              SET_BATTLE_OR_DEATH_QUOTE FlagChapter07_IshtoreBattleQuote, dialogueCh7BattleIshtore_RaisaDead, 0
        BREAK_STATE_CHECKS

        UNSET_FLAG FlagChapter07_IshtoreBattleQuoteCheck

        CHECK_FLAG_SET FlagChapter07_IshtoreDied
          CHECK_FLAG_UNSET FlagChapter07_IshtoreDeathQuoteRaisaAlive
            CHECK_FLAG_UNSET FlagChapter07_RaisaDied
              SET_BATTLE_OR_DEATH_QUOTE FlagChapter07_IshtoreDeathQuoteRaisaAlive, dialogueDeathIshtore_RaisaAlive, 1
        BREAK_STATE_CHECKS
    ...
    .section Chapter07EventDataSection
      ...
      aChapter07MelgenCastle ; 86/EC0F
        ...
        .structChapterCastleLocationEntry Ch07_Melgen, MergenName, [17, 57], $FC, None
      ...
      aFactionGroupData2B ; 86/ED8D
        ...
        .structFactionGroupData FactionMergen, BattleHUDColorBrown, BattleBannerFriege, None, aFactionGroupData2B._Locations, aFactionGroupData2B._GroupAI
      ...
      aFactionGroupData2C ; 86/EDA2
        ...
        .structFactionGroupData FactionUlster, BattleHUDColorBrown, BattleBannerFriege, None, aFactionGroupData2C._Locations, aFactionGroupData2C._GroupAI
