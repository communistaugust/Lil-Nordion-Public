    ...
    .section Chapter08EventsSection
      ...
      aChapter08MapEvents ; 86/EEC9
        ...
        CHECK_UNIT_DIED_TO FlagAlways, Ishtar, AnyCharacter
          COMBATANTS_STAY_ON_MAP

        CHECK_UNIT_DIED FlagChapter08_IshtarDiedCheck, Ishtar
        ...
        CHECK_SPECIAL_CRIT FlagAlways, 3, Banba2
          SET_BATTLE_OR_DEATH_QUOTE FlagChapter08_BanbaTriangleAttackQuote, dialogueCh8BattleBanba_TriangleAttack, 0

        CHECK_SPECIAL_CRIT FlagAlways, 3, Fodla2
          SET_BATTLE_OR_DEATH_QUOTE FlagChapter08_FotlaTriangleAttackQuote, dialogueCh8BattleFodla_TriangleAttack, 0

        CHECK_SPECIAL_CRIT FlagAlways, 3, Eriu2
          SET_BATTLE_OR_DEATH_QUOTE FlagChapter08_EriuTriangleAttackQuote, dialogueCh8BattleEriu_TriangleAttack, 0

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, Patty, AnyFactionSlot, Febail
          SET_BATTLE_OR_DEATH_QUOTE FlagChapter08_PattyDaisy_FebailAsaelloBattleQuote, dialogueCh8BattleFebailAsaello_PattyDaisy, 0

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, Daisy, AnyFactionSlot, Asaello
          SET_BATTLE_OR_DEATH_QUOTE FlagChapter08_PattyDaisy_FebailAsaelloBattleQuote, dialogueCh8BattleFebailAsaello_PattyDaisy, 0

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, Febail, AnyFactionSlot, Bloom2
          SET_PRECOMBAT_DIALOGUE FlagChapter08_FebailAsaello_BloomBattleQuote, dialogueCh8BattleBloom_FebailAsaello, $46

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, Asaello, AnyFactionSlot, Bloom2
          SET_PRECOMBAT_DIALOGUE FlagChapter08_FebailAsaello_BloomBattleQuote, dialogueCh8BattleBloom_FebailAsaello, $46

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, Tine, AnyFactionSlot, Ishtar
          SET_PRECOMBAT_DIALOGUE FlagChapter08_TineLinda_IshtarBattleQuote, dialogueCh8BattleIshtar_TineLinda, $46

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, Linda, AnyFactionSlot, Ishtar
          SET_PRECOMBAT_DIALOGUE FlagChapter08_TineLinda_IshtarBattleQuote, dialogueCh8BattleIshtar_TineLinda, $46

        CHECK_UNITS_FIGHTING_1TO2RANGE FlagAlways, FS_Player, Tine, AnyFactionSlot, Bloom2
          SET_PRECOMBAT_DIALOGUE FlagChapter08_TineLinda_BloomBattleQuote, dialogueCh8BattleBloom_TineLinda, $46

        CHECK_UNITS_FIGHTING_1TO2RANGE FlagAlways, FS_Player, Linda, AnyFactionSlot, Bloom2
          SET_PRECOMBAT_DIALOGUE FlagChapter08_TineLinda_BloomBattleQuote, dialogueCh8BattleBloom_TineLinda, $46

        CHECK_UNITS_FIGHTING_1TO2RANGE FlagAlways, FS_Player, Seliph, AnyFactionSlot, Bloom2
          SET_PRECOMBAT_DIALOGUE FlagChapter08_SeliphBloomBattleQuote, dialogueCh8BattleBloom_Seliph, $46

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, AnyCharacter, AnyFactionSlot, Febail
          SET_BATTLE_OR_DEATH_QUOTE FlagChapter08_FebailAsaello_BattleQuote, dialogueCh8BattleFebailAsaello, 0

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, AnyCharacter, AnyFactionSlot, Asaello
          SET_BATTLE_OR_DEATH_QUOTE FlagChapter08_FebailAsaello_BattleQuote, dialogueCh8BattleFebailAsaello, 0

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, AnyCharacter, AnyFactionSlot, Ishtar
          SET_BATTLE_OR_DEATH_QUOTE FlagChapter08_IshtarBattleQuote, dialogueCh8BattleIshtar, 0

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, AnyCharacter, AnyFactionSlot, Muhammad
          SET_BATTLE_OR_DEATH_QUOTE FlagChapter08_MuhammadBattleQuote, dialogueCh8BattleMuhammad, 0

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, AnyCharacter, AnyFactionSlot, Ovo
          SET_BATTLE_OR_DEATH_QUOTE FlagChapter08_OvoBattleQuote, dialogueCh8BattleOvo, 0

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, AnyCharacter, AnyFactionSlot, Banba2
          SET_BATTLE_OR_DEATH_QUOTE FlagChapter08_BanbaBattleQuote, dialogueCh8BattleBanba, 0

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, AnyCharacter, AnyFactionSlot, Fodla2
          SET_BATTLE_OR_DEATH_QUOTE FlagChapter08_FotlaBattleQuote, dialogueCh8BattleFodla, 0

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, AnyCharacter, AnyFactionSlot, Eriu2
          SET_BATTLE_OR_DEATH_QUOTE FlagChapter08_EriuBattleQuote, dialogueCh8BattleEriu, 0

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, AnyCharacter, AnyFactionSlot, Bloom2
          SET_BATTLE_OR_DEATH_QUOTE FlagChapter08_BloomBattleQuote, dialogueCh8BattleBloom, 0

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, AnyCharacter, AnyFactionSlot, Gortach
          SET_BATTLE_OR_DEATH_QUOTE FlagChapter08_CoulterBattleQuote, dialogueCh8BattleGortach, 0

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, AnyCharacter, AnyFactionSlot, Maykov
          SET_BATTLE_OR_DEATH_QUOTE FlagChapter08_MaykovBattleQuote, dialogueCh8BattleMaykov, 0
    ...
    .section Chapter08EventDataSection
      ...
      aFactionGroupData2E ; 86/F3C5
        ...
        .structFactionGroupData FactionConnacht, BattleHUDColorBrown, BattleBannerFriege, None, aFactionGroupData2E._Locations, aFactionGroupData2E._GroupAI
      ...
      aFactionGroupData2F ; 86/F3EC
        ...
        .structFactionGroupData FactionMunster, BattleHUDColorBrown, BattleBannerFriege, None, aFactionGroupData2F._Locations, aFactionGroupData2F._GroupAI
