    ...
    .section Chapter03EventsSection
      ...
      aChapter03MapEvents ; 86/D3CF
        ...
        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, Lachesis, AnyFactionSlot, EldiganCh03
          SET_BATTLE_OR_DEATH_QUOTE FlagChapter03_LachesisEldiganBattleQuote, dialogueCh3BattleEldigan_Lachesis, 0

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, Sigurd, AnyFactionSlot, EldiganCh03
          SET_PRECOMBAT_DIALOGUE FlagChapter03_SigurdEldiganBattleQuote, dialogueCh3BattleEldigan_Sigurd, $46

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, Brigid, AnyFactionSlot, Dobar
          SET_PRECOMBAT_DIALOGUE FlagChapter03_BrigidDuvallBattleQuote, dialogueCh3BattleDobar_Brigid, $43

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, Lachesis, AnyFactionSlot, ChagallCh03
          SET_PRECOMBAT_DIALOGUE FlagChapter03_LachesisChagallBattleQuote, dialogueCh3BattleChagall_Lachesis, $46

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, Sigurd, AnyFactionSlot, ChagallCh03
          SET_PRECOMBAT_DIALOGUE FlagChapter03_SigurdChagallBattleQuote, dialogueCh3BattleChagall_Sigurd, $46

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, AnyCharacter, AnyFactionSlot, Jacobi
          SET_BATTLE_OR_DEATH_QUOTE FlagChapter03_JacobiBattleQuote, dialogueCh3BattleJacobi, 0

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, AnyCharacter, AnyFactionSlot, EldiganCh03
          SET_BATTLE_OR_DEATH_QUOTE FlagChapter03_EldiganBattleQuote, dialogueCh3BattleEldigan, 0

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, AnyCharacter, AnyFactionSlot, ChagallCh03
          SET_BATTLE_OR_DEATH_QUOTE FlagChapter03_ChagallBattleQuote, dialogueCh3BattleChagall, 0

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, AnyCharacter, AnyFactionSlot, Papilio
          SET_BATTLE_OR_DEATH_QUOTE FlagChapter03_PapilioBattleQuote, dialogueCh3BattlePapilio, 0

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, AnyCharacter, AnyFactionSlot, Dobar
          SET_BATTLE_OR_DEATH_QUOTE FlagChapter03_DuvallBattleQuote, dialogueCh3BattleDobar, 0

        CHECK_UNITS_FIGHTING FlagAlways, FS_Player, AnyCharacter, AnyFactionSlot, Pisear
          SET_BATTLE_OR_DEATH_QUOTE FlagChapter03_PizarreBattleQuote, dialogueCh3BattlePisear, 0
